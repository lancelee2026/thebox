...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Eh(e,t,i){const n=new Float32Array(on),r=new F(0,1,0);return new jt({name:"SphericalGaussianBlur",defines:{n:on,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:mr(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fa(){return new jt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:mr(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ba(){return new jt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:mr(),fragmentShader:`
	...
	`}var za=class extends Jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},n=[i,i,i,i,i,i];this.texture=new Ma(n),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},n=new lr(5,5,5),r=new jt({name:"CubemapFromEquirect",uniforms:rn(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:1,blending:0});r.uniforms.tEquirect.value=t;const s=new lt(n,r),a=t.minFilter;return t.minFilter===1008&&(t.minFilter=Pt),new Qc(1,10,this).update(e,s),t.minFilter=a,s.geometry.dispose(),s.material.dispose(),this}clear(e,t=!0,i=!0,n=!0){const r=e.getRenderTarget();for(let s=0;s<6;s++)e.setRenderTarget(this,s),e.clear(t,i,n);e.setRenderTarget(r)}};function bh(e){let t=new WeakMap,i=new WeakMap,n=null;function r(h,d=!1){return h==null?null:d?a(h):s(h)}function s(h){if(h&&h.isTexture){const d=h.mapping;if(d===303||d===304)if(t.has(h)){const _=t.get(h).texture;return o(_,h.mapping)}else{const _=h.image;if(_&&_.height>0){const M=new za(_.height);return M.fromEquirectangularTexture(e,h),t.set(h,M),h.addEventListener("dispose",l),o(M.texture,h.mapping)}else return null}}return h}function a(h){if(h&&h.isTexture){const d=h.mapping,_=d===303||d===304,M=d===301||d===302;if(_||M){let m=i.get(h);const p=m!==void 0?m.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==p)return n===null&&(n=new Na(e)),m=_?n.fromEquirectangular(h,m):n.fromCubemap(h,m),m.texture.pmremVersion=h.pmremVersion,i.set(h,m),m.texture;if(m!==void 0)return m.texture;{const T=h.image;return _&&T&&T.height>0||M&&T&&c(T)?(n===null&&(n=new Na(e)),m=_?n.fromEquirectangular(h):n.fromCubemap(h),m.texture.pmremVersion=h.pmremVersion,i.set(h,m),h.addEventListener("dispose",u),m.texture):null}}}return h}function o(h,d){return d===303?h.mapping=301:d===304&&(h.mapping=302),h}function c(h){let d=0;const _=6;for(let M=0;M<_;M++)h[M]!==void 0&&d++;return d===_}function l(h){const d=h.target;d.removeEventListener("dispose",l);const _=t.get(d);_!==void 0&&(t.delete(d),_.dispose())}function u(h){const d=h.target;d.removeEventListener("dispose",u);const _=i.get(d);_!==void 0&&(i.delete(d),_.dispose())}function f(){t=new WeakMap,i=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:r,dispose:f}}function Th(e){const t={};function i(n){if(t[n]!==void 0)return t[n];const r=e.getExtension(n);return t[n]=r,r}return{has:function(n){return i(n)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(n){const r=i(n);return r===null&&Vi("WebGLRenderer: "+n+" extension not supported."),r}}}function Ah(e,t,i,n){const r={},s=new WeakMap;function a(f){const h=f.target;h.index!==null&&t.remove(h.index);for(const _ in h.attributes)t.remove(h.attributes[_]);h.removeEventListener("dispose",a),delete r[h.id];const d=s.get(h);d&&(t.remove(d),s.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,i.memory.geometries--}function o(f,h){return r[h.id]===!0||(h.addEventListener("dispose",a),r[h.id]=!0,i.memory.geometries++),h}function c(f){const h=f.attributes;for(const d in h)t.update(h[d],e.ARRAY_BUFFER)}function l(f){const h=[],d=f.index,_=f.attributes.position;let M=0;if(_===void 0)return;if(d!==null){const T=d.array;M=d.version;for(let w=0,y=T.length;w<y;w+=3){const A=T[w+0],R=T[w+1],P=T[w+2];h.push(A,R,R,P,P,A)}}else{const T=_.array;M=_.version;for(let w=0,y=T.length/3-1;w<y;w+=3){const A=w+0,R=w+1,P=w+2;h.push(A,R,R,P,P,A)}}const m=new(_.count>=65535?ga:ma)(h,1);m.version=M;const p=s.get(f);p&&t.remove(p),s.set(f,m)}function u(f){const h=s.get(f);if(h){const d=f.index;d!==null&&h.version<d.version&&l(f)}else l(f);return s.get(f)}return{get:o,update:c,getWireframeAttribute:u}}function wh(e,t,i){let n;function r(f){n=f}let s,a;function o(f){s=f.type,a=f.bytesPerElement}function c(f,h){e.drawElements(n,h,s,f*a),i.update(h,n,1)}function l(f,h,d){d!==0&&(e.drawElementsInstanced(n,h,s,f*a,d),i.update(h,n,d))}function u(f,h,d){if(d===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,h,0,s,f,0,d);let _=0;for(let M=0;M<d;M++)_+=h[M];i.update(_,n,1)}this.setMode=r,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=u}function Rh(e){const t={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(i.calls++,a){case e.TRIANGLES:i.triangles+=o*(s/3);break;case e.LINES:i.lines+=o*(s/2);break;case e.LINE_STRIP:i.lines+=o*(s-1);break;case e.LINE_LOOP:i.lines+=o*s;break;case e.POINTS:i.points+=o*s;break;default:Re("WebGLInfo: Unknown draw mode:",a)}}function r(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:t,render:i,programs:null,autoReset:!0,reset:r,update:n}}function Ch(e,t,i){const n=new WeakMap,r=new nt;function s(a,o,c){const l=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,f=u!==void 0?u.length:0;let h=n.get(o);if(h===void 0||h.count!==f){let W=function(){v.dispose(),n.delete(o),o.removeEventListener("dispose",W)};var d=W;h!==void 0&&h.texture.dispose();const _=o.morphAttributes.position!==void 0,M=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,p=o.morphAttributes.position||[],T=o.morphAttributes.normal||[],w=o.morphAttributes.color||[];let y=0;_===!0&&(y=1),M===!0&&(y=2),m===!0&&(y=3);let A=o.attributes.position.count*y,R=1;A>t.maxTextureSize&&(R=Math.ceil(A/t.maxTextureSize),A=t.maxTextureSize);const P=new Float32Array(A*R*4*f),v=new ra(P,A,R,f);v.type=Bn,v.needsUpdate=!0;const E=y*4;for(let b=0;b<f;b++){const z=p[b],H=T[b],Y=w[b],k=A*R*4*b;for(let K=0;K<z.count;K++){const N=K*E;_===!0&&(r.fromBufferAttribute(z,K),P[k+N+0]=r.x,P[k+N+1]=r.y,P[k+N+2]=r.z,P[k+N+3]=0),M===!0&&(r.fromBufferAttribute(H,K),P[k+N+4]=r.x,P[k+N+5]=r.y,P[k+N+6]=r.z,P[k+N+7]=0),m===!0&&(r.fromBufferAttribute(Y,K),P[k+N+8]=r.x,P[k+N+9]=r.y,P[k+N+10]=r.z,P[k+N+11]=Y.itemSize===4?r.w:1)}}h={count:f,texture:v,size:new Ge(A,R)},n.set(o,h),o.addEventListener("dispose",W)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(e,"morphTexture",a.morphTexture,i);else{let _=0;for(let m=0;m<l.length;m++)_+=l[m];const M=o.morphTargetsRelative?1:1-_;c.getUniforms().setValue(e,"morphTargetBaseInfluence",M),c.getUniforms().setValue(e,"morphTargetInfluences",l)}c.getUniforms().setValue(e,"morphTargetsTexture",h.texture,i),c.getUniforms().setValue(e,"morphTargetsTextureSize",h.size)}return{update:s}}function Ph(e,t,i,n,r){let s=new WeakMap;function a(l){const u=r.render.frame,f=l.geometry,h=t.get(l,f);if(s.get(h)!==u&&(t.update(h),s.set(h,u)),l.isInstancedMesh&&(l.hasEventListener("dispose",c)===!1&&l.addEventListener("dispose",c),s.get(l)!==u&&(i.update(l.instanceMatrix,e.ARRAY_BUFFER),l.instanceColor!==null&&i.update(l.instanceColor,e.ARRAY_BUFFER),s.set(l,u))),l.isSkinnedMesh){const d=l.skeleton;s.get(d)!==u&&(d.update(),s.set(d,u))}return h}function o(){s=new WeakMap}function c(l){const u=l.target;u.removeEventListener("dispose",c),n.releaseStatesOfObject(u),i.remove(u.instanceMatrix),u.instanceColor!==null&&i.remove(u.instanceColor)}return{update:a,dispose:o}}var Ih={1:"LINEAR_TONE_MAPPING",2:"REINHARD_TONE_MAPPING",3:"CINEON_TONE_MAPPING",4:"ACES_FILMIC_TONE_MAPPING",6:"AGX_TONE_MAPPING",7:"NEUTRAL_TONE_MAPPING",5:"CUSTOM_TONE_MAPPING"};function Lh(e,t,i,n,r,s){const a=new Jt(t,i,{type:e,depthBuffer:r,stencilBuffer:s,samples:n?4:0,depthTexture:r?new nn(t,i):void 0}),o=new Jt(t,i,{type:wi,depthBuffer:!1,stencilBuffer:!1}),c=new Mi;c.setAttribute("position",new Ft([-1,3,0,-1,-1,0,3,-1,0],3)),c.setAttribute("uv",new Ft([0,2,0,0,2,0],2));const l=new Dc({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),u=new lt(c,l),f=new fr(-1,1,1,-1,0,1);let h=null,d=null,_=!1,M,m=null,p=[],T=!1;this.setSize=function(w,y){a.setSize(w,y),o.setSize(w,y);for(let A=0;A<p.length;A++){const R=p[A];R.setSize&&R.setSize(w,y)}},this.setEffects=function(w){p=w,T=p.length>0&&p[0].isRenderPass===!0;const y=a.width,A=a.height;for(let R=0;R<p.length;R++){const P=p[R];P.setSize&&P.setSize(y,A)}},this.begin=function(w,y){if(_||w.toneMapping===0&&p.length===0)return!1;if(m=y,y!==null){const A=y.width,R=y.height;(a.width!==A||a.height!==R)&&this.setSize(A,R)}return T===!1&&w.setRenderTarget(a),M=w.toneMapping,w.toneMapping=0,!0},this.hasRenderPass=function(){return T},this.end=function(w,y){w.toneMapping=M,_=!0;let A=a,R=o;for(let P=0;P<p.length;P++){const v=p[P];if(v.enabled!==!1&&(v.render(w,R,A,y),v.needsSwap!==!1)){const E=A;A=R,R=E}}if(h!==w.outputColorSpace||d!==w.toneMapping){h=w.outputColorSpace,d=w.toneMapping,l.defines={},ze.getTransfer(h)==="srgb"&&(l.defines.SRGB_TRANSFER="");const P=Ih[d];P&&(l.defines[P]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=A.texture,w.setRenderTarget(m),w.render(u,f),m=null,_=!1},this.isCompositing=function(){return _},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),c.dispose(),l.dispose()}}var Va=new Ot,gs=new nn(1,1),Ga=new ra,ka=new sc,Ha=new Ma,Wa=[],Xa=[],qa=new Float32Array(16),Ya=new Float32Array(9),Ka=new Float32Array(4);function cn(e,t,i){const n=e[0];if(n<=0||n>0)return e;const r=t*i;let s=Wa[r];if(s===void 0&&(s=new Float32Array(r),Wa[r]=s),t!==0){n.toArray(s,0);for(let a=1,o=0;a!==t;++a)o+=i,e[a].toArray(s,o)}return s}function ft(e,t){if(e.length!==t.length)return!1;for(let i=0,n=e.length;i<n;i++)if(e[i]!==t[i])return!1;return!0}function pt(e,t){for(let i=0,n=t.length;i<n;i++)e[i]=t[i]}function gr(e,t){let i=Xa[t];i===void 0&&(i=new Int32Array(t),Xa[t]=i);for(let n=0;n!==t;++n)i[n]=e.allocateTextureUnit();return i}function Dh(e,t){const i=this.cache;i[0]!==t&&(e.uniform1f(this.addr,t),i[0]=t)}function Uh(e,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(e.uniform2f(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(ft(i,t))return;e.uniform2fv(this.addr,t),pt(i,t)}}function Nh(e,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(e.uniform3f(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else if(t.r!==void 0)(i[0]!==t.r||i[1]!==t.g||i[2]!==t.b)&&(e.uniform3f(this.addr,t.r,t.g,t.b),i[0]=t.r,i[1]=t.g,i[2]=t.b);else{if(ft(i,t))return;e.uniform3fv(this.addr,t),pt(i,t)}}function Oh(e,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(e.uniform4f(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(ft(i,t))return;e.uniform4fv(this.addr,t),pt(i,t)}}function Fh(e,t){const i=this.cache,n=t.elements;if(n===void 0){if(ft(i,t))return;e.uniformMatrix2fv(this.addr,!1,t),pt(i,t)}else{if(ft(i,n))return;Ka.set(n),e.uniformMatrix2fv(this.addr,!1,Ka),pt(i,n)}}function Bh(e,t){const i=this.cache,n=t.elements;if(n===void 0){if(ft(i,t))return;e.uniformMatrix3fv(this.addr,!1,t),pt(i,t)}else{if(ft(i,n))return;Ya.set(n),e.uniformMatrix3fv(this.addr,!1,Ya),pt(i,n)}}function zh(e,t){const i=this.cache,n=t.elements;if(n===void 0){if(ft(i,t))return;e.uniformMatrix4fv(this.addr,!1,t),pt(i,t)}else{if(ft(i,n))return;qa.set(n),e.uniformMatrix4fv(this.addr,!1,qa),pt(i,n)}}function Vh(e,t){const i=this.cache;i[0]!==t&&(e.uniform1i(this.addr,t),i[0]=t)}function Gh(e,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(e.uniform2i(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(ft(i,t))return;e.uniform2iv(this.addr,t),pt(i,t)}}function kh(e,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(e.uniform3i(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else{if(ft(i,t))return;e.uniform3iv(this.addr,t),pt(i,t)}}function Hh(e,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(e.uniform4i(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(ft(i,t))return;e.uniform4iv(this.addr,t),pt(i,t)}}function Wh(e,t){const i=this.cache;i[0]!==t&&(e.uniform1ui(this.addr,t),i[0]=t)}function Xh(e,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(e.uniform2ui(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(ft(i,t))return;e.uniform2uiv(this.addr,t),pt(i,t)}}function qh(e,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(e.uniform3ui(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else{if(ft(i,t))return;e.uniform3uiv(this.addr,t),pt(i,t)}}function Yh(e,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(e.uniform4ui(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(ft(i,t))return;e.uniform4uiv(this.addr,t),pt(i,t)}}function Kh(e,t,i){const n=this.cache,r=i.allocateTextureUnit();n[0]!==r&&(e.uniform1i(this.addr,r),n[0]=r);let s;this.type===e.SAMPLER_2D_SHADOW?(gs.compareFunction=i.isReversedDepthBuffer()?518:515,s=gs):s=Va,i.setTexture2D(t||s,r)}function Zh(e,t,i){const n=this.cache,r=i.allocateTextureUnit();n[0]!==r&&(e.uniform1i(this.addr,r),n[0]=r),i.setTexture3D(t||ka,r)}function $h(e,t,i){const n=this.cache,r=i.allocateTextureUnit();n[0]!==r&&(e.uniform1i(this.addr,r),n[0]=r),i.setTextureCube(t||Ha,r)}function Jh(e,t,i){const n=this.cache,r=i.allocateTextureUnit();n[0]!==r&&(e.uniform1i(this.addr,r),n[0]=r),i.setTexture2DArray(t||Ga,r)}function Qh(e){switch(e){case 5126:return Dh;case 35664:return Uh;case 35665:return Nh;case 35666:return Oh;case 35674:return Fh;case 35675:return Bh;case 35676:return zh;case 5124:case 35670:return Vh;case 35667:case 35671:return Gh;case 35668:case 35672:return kh;case 35669:case 35673:return Hh;case 5125:return Wh;case 36294:return Xh;case 36295:return qh;case 36296:return Yh;case 35678:case 36198:case 36298:case 36306:case 35682:return Kh;case 35679:case 36299:case 36307:return Zh;case 35680:case 36300:case 36308:case 36293:return $h;case 36289:case 36303:case 36311:case 36292:return Jh}}function jh(e,t){e.uniform1fv(this.addr,t)}function eu(e,t){const i=cn(t,this.size,2);e.uniform2fv(this.addr,i)}function tu(e,t){const i=cn(t,this.size,3);e.uniform3fv(this.addr,i)}function iu(e,t){const i=cn(t,this.size,4);e.uniform4fv(this.addr,i)}function nu(e,t){const i=cn(t,this.size,4);e.uniformMatrix2fv(this.addr,!1,i)}function ru(e,t){const i=cn(t,this.size,9);e.uniformMatrix3fv(this.addr,!1,i)}function su(e,t){const i=cn(t,this.size,16);e.uniformMatrix4fv(this.addr,!1,i)}function au(e,t){e.uniform1iv(this.addr,t)}function ou(e,t){e.uniform2iv(this.addr,t)}function lu(e,t){e.uniform3iv(this.addr,t)}function cu(e,t){e.uniform4iv(this.addr,t)}function hu(e,t){e.uniform1uiv(this.addr,t)}function uu(e,t){e.uniform2uiv(this.addr,t)}function du(e,t){e.uniform3uiv(this.addr,t)}function fu(e,t){e.uniform4uiv(this.addr,t)}function pu(e,t,i){const n=this.cache,r=t.length,s=gr(i,r);ft(n,s)||(e.uniform1iv(this.addr,s),pt(n,s));let a;this.type===e.SAMPLER_2D_SHADOW?a=gs:a=Va;for(let o=0;o!==r;++o)i.setTexture2D(t[o]||a,s[o])}function mu(e,t,i){const n=this.cache,r=t.length,s=gr(i,r);ft(n,s)||(e.uniform1iv(this.addr,s),pt(n,s));for(let a=0;a!==r;++a)i.setTexture3D(t[a]||ka,s[a])}function gu(e,t,i){const n=this.cache,r=t.length,s=gr(i,r);ft(n,s)||(e.uniform1iv(this.addr,s),pt(n,s));for(let a=0;a!==r;++a)i.setTextureCube(t[a]||Ha,s[a])}function vu(e,t,i){const n=this.cache,r=t.length,s=gr(i,r);ft(n,s)||(e.uniform1iv(this.addr,s),pt(n,s));for(let a=0;a!==r;++a)i.setTexture2DArray(t[a]||Ga,s[a])}function _u(e){switch(e){case 5126:return jh;case 35664:return eu;case 35665:return tu;case 35666:return iu;case 35674:return nu;case 35675:return ru;case 35676:return su;case 5124:case 35670:return au;case 35667:case 35671:return ou;case 35668:case 35672:return lu;case 35669:case 35673:return cu;case 5125:return hu;case 36294:return uu;case 36295:return du;case 36296:return fu;case 35678:case 36198:case 36298:case 36306:case 35682:return pu;case 35679:case 36299:case 36307:return mu;case 35680:case 36300:case 36308:case 36293:return gu;case 36289:case 36303:case 36311:case 36292:return vu}}var xu=class{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=Qh(t.type)}},Mu=class{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=_u(t.type)}},Su=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const n=this.seq;for(let r=0,s=n.length;r!==s;++r){const a=n[r];a.setValue(e,t[a.id],i)}}},vs=/(\w+)(\])?(\[|\.)?/g;function Za(e,t){e.seq.push(t),e.map[t.id]=t}function yu(e,t,i){const n=e.name,r=n.length;for(vs.lastIndex=0;;){const s=vs.exec(n),a=vs.lastIndex;let o=s[1];const c=s[2]==="]",l=s[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===r){Za(i,l===void 0?new xu(o,e,t):new Mu(o,e,t));break}else{let u=i.map[o];u===void 0&&(u=new Su(o),Za(i,u)),i=u}}}var vr=class{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<i;++s){const a=e.getActiveUniform(t,s);yu(a,e.getUniformLocation(t,a.name),this)}const n=[],r=[];for(const s of this.seq)s.type===e.SAMPLER_2D_SHADOW||s.type===e.SAMPLER_CUBE_SHADOW||s.type===e.SAMPLER_2D_ARRAY_SHADOW?n.push(s):r.push(s);n.length>0&&(this.seq=n.concat(r))}setValue(e,t,i,n){const r=this.map[t];r!==void 0&&r.setValue(e,i,n)}setOptional(e,t,i){const n=t[i];n!==void 0&&this.setValue(e,i,n)}static upload(e,t,i,n){for(let r=0,s=t.length;r!==s;++r){const a=t[r],o=i[a.id];o.needsUpdate!==!1&&a.setValue(e,o.value,n)}}static seqWithValue(e,t){const i=[];for(let n=0,r=e.length;n!==r;++n){const s=e[n];s.id in t&&i.push(s)}return i}};function $a(e,t,i){const n=e.createShader(t);return e.shaderSource(n,i),e.compileShader(n),n}var Eu=37297,bu=0;function Tu(e,t){const i=e.split(`
`),n=[],r=Math.max(t-6,0),s=Math.min(t+6,i.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===t?">":" "} ${o}: ${i[a]}`)}return n.join(`
`)}var Ja=new De;function Au(e){ze._getMatrix(Ja,ze.workingColorSpace,e);const t=`mat3( ${Ja.elements.map(i=>i.toFixed(4))} )`;switch(ze.getTransfer(e)){case Gn:return[t,"LinearTransferOETF"];case kn:return[t,"sRGBTransferOETF"];default:return Te("WebGLProgram: Unsupported color space: ",e),[t,"LinearTransferOETF"]}}function Qa(e,t,i){const n=e.getShaderParameter(t,e.COMPILE_STATUS),r=(e.getShaderInfoLog(t)||"").trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return i.toUpperCase()+`

`+r+`

`+Tu(e.getShaderSource(t),a)}else return r}function wu(e,t){const i=Au(t);return[`vec4 ${e}( vec4 value ) {`,`	return ${i[1]}( vec4( value.rgb * ${i[0]}, value.a ) );`,"}"].join(`
`)}var Ru={1:"Linear",2:"Reinhard",3:"Cineon",4:"ACESFilmic",6:"AgX",7:"Neutral",5:"Custom"};function Cu(e,t){const i=Ru[t];return i===void 0?(Te("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+e+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+e+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}var _r=new F;function Pu(){return ze.getLuminanceCoefficients(_r),["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${_r.x.toFixed(4)}, ${_r.y.toFixed(4)}, ${_r.z.toFixed(4)} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Iu(e){return[e.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",e.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(In).join(`
`)}function Lu(e){const t=[];for(const i in e){const n=e[i];n!==!1&&t.push("#define "+i+" "+n)}return t.join(`
`)}function Du(e,t){const i={},n=e.getProgramParameter(t,e.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=e.getActiveAttrib(t,r),a=s.name;let o=1;s.type===e.FLOAT_MAT2&&(o=2),s.type===e.FLOAT_MAT3&&(o=3),s.type===e.FLOAT_MAT4&&(o=4),i[a]={type:s.type,location:e.getAttribLocation(t,a),locationSize:o}}return i}function In(e){return e!==""}function ja(e,t){const i=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return e.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,i).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function eo(e,t){return e.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}var Uu=/^[ \t]*#include +<([\w\d./]+)>/gm;function _s(e){return e.replace(Uu,Ou)}var Nu=new Map;function Ou(e,t){let i=Ue[t];if(i===void 0){const n=Nu.get(t);if(n!==void 0)i=Ue[n],Te('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+t+">")}return _s(i)}var Fu=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function to(e){return e.replace(Fu,Bu)}function Bu(e,t,i,n){let r="";for(let s=parseInt(t);s<parseInt(i);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function io(e){let t=`precision ${e.precision} float;
...
`)+`
`+p);const w=T+m+a,y=T+p+o,A=$a(r,r.VERTEX_SHADER,w),R=$a(r,r.FRAGMENT_SHADER,y);r.attachShader(M,A),r.attachShader(M,R),i.index0AttributeName!==void 0?r.bindAttribLocation(M,0,i.index0AttributeName):i.hasPositionAttribute===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function P(b){if(e.debug.checkShaderErrors){const z=r.getProgramInfoLog(M)||"",H=r.getShaderInfoLog(A)||"",Y=r.getShaderInfoLog(R)||"",k=z.trim(),K=H.trim(),N=Y.trim();let j=!0,ee=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if(j=!1,typeof e.debug.onShaderError=="function")e.debug.onShaderError(r,M,A,R);else{const ne=Qa(r,A,"vertex"),fe=Qa(r,R,"fragment");Re("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
...
}`,xd=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const i=new Sa(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new jt({vertexShader:vd,fragmentShader:_d,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new lt(new cr(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Md=class extends Ri{constructor(e,t){super();const i=this;let n=null,r=1,s=null,a="local-floor",o=1,c=null,l=null,u=null,f=null,h=null,d=null;const _=typeof XRWebGLBinding!="undefined",M=new xd,m={},p=t.getContextAttributes();let T=null,w=null;const y=[],A=[],R=new Ge;let P=null;const v=new Yt;v.viewport=new nt;const E=new Yt;E.viewport=new nt;const W=[v,E],b=new jc;let z=null,H=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(X){let se=y[X];return se===void 0&&(se=new Wr,y[X]=se),se.getTargetRaySpace()},this.getControllerGrip=function(X){let se=y[X];return se===void 0&&(se=new Wr,y[X]=se),se.getGripSpace()},this.getHand=function(X){let se=y[X];return se===void 0&&(se=new Wr,y[X]=se),se.getHandSpace()};function Y(X){const se=A.indexOf(X.inputSource);if(se===-1)return;const me=y[se];me!==void 0&&(me.update(X.inputSource,X.frame,c||s),me.dispatchEvent({type:X.type,data:X.inputSource}))}function k(){n.removeEventListener("select",Y),n.removeEventListener("selectstart",Y),n.removeEventListener("selectend",Y),n.removeEventListener("squeeze",Y),n.removeEventListener("squeezestart",Y),n.removeEventListener("squeezeend",Y),n.removeEventListener("end",k),n.removeEventListener("inputsourceschange",K);for(let X=0;X<y.length;X++){const se=A[X];se!==null&&(A[X]=null,y[X].disconnect(se))}z=null,H=null,M.reset();for(const X in m)delete m[X];e.setRenderTarget(T),h=null,f=null,u=null,n=null,w=null,Ze.stop(),i.isPresenting=!1,e.setPixelRatio(P),e.setSize(R.width,R.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(X){r=X,i.isPresenting===!0&&Te("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(X){a=X,i.isPresenting===!0&&Te("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||s},this.setReferenceSpace=function(X){c=X},this.getBaseLayer=function(){return f!==null?f:h},this.getBinding=function(){return u===null&&_&&(u=new XRWebGLBinding(n,t)),u},this.getFrame=function(){return d},this.getSession=function(){return n},this.setSession=async function(X){if(n=X,n!==null){if(T=e.getRenderTarget(),n.addEventListener("select",Y),n.addEventListener("selectstart",Y),n.addEventListener("selectend",Y),n.addEventListener("squeeze",Y),n.addEventListener("squeezestart",Y),n.addEventListener("squeezeend",Y),n.addEventListener("end",k),n.addEventListener("inputsourceschange",K),p.xrCompatible!==!0&&await t.makeXRCompatible(),P=e.getPixelRatio(),e.getSize(R),_&&"createProjectionLayer"in XRWebGLBinding.prototype){let se=null,me=null,ue=null;p.depth&&(ue=p.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,se=p.stencil?ks:vn,me=p.stencil?Gs:Ai);const Ae={colorFormat:t.RGBA8,depthFormat:ue,scaleFactor:r};u=this.getBinding(),f=u.createProjectionLayer(Ae),n.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),w=new Jt(f.textureWidth,f.textureHeight,{format:gn,type:pi,depthTexture:new nn(f.textureWidth,f.textureHeight,me,void 0,void 0,void 0,void 0,void 0,void 0,se),stencilBuffer:p.stencil,colorSpace:e.outputColorSpace,samples:p.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const se={antialias:p.antialias,alpha:!0,depth:p.depth,stencil:p.stencil,framebufferScaleFactor:r};h=new XRWebGLLayer(n,t,se),n.updateRenderState({baseLayer:h}),e.setPixelRatio(1),e.setSize(h.framebufferWidth,h.framebufferHeight,!1),w=new Jt(h.framebufferWidth,h.framebufferHeight,{format:gn,type:pi,colorSpace:e.outputColorSpace,stencilBuffer:p.stencil,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}w.isXRRenderTarget=!0,this.setFoveation(o),c=null,s=await n.requestReferenceSpace(a),Ze.setContext(n),Ze.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(n!==null)return n.environmentBlendMode},this.getDepthTexture=function(){return M.getDepthTexture()};function K(X){for(let se=0;se<X.removed.length;se++){const me=X.removed[se],ue=A.indexOf(me);ue>=0&&(A[ue]=null,y[ue].disconnect(me))}for(let se=0;se<X.added.length;se++){const me=X.added[se];let ue=A.indexOf(me);if(ue===-1){for(let Ce=0;Ce<y.length;Ce++)if(Ce>=A.length){A.push(me),ue=Ce;break}else if(A[Ce]===null){A[Ce]=me,ue=Ce;break}if(ue===-1)break}const Ae=y[ue];Ae&&Ae.connect(me)}}const N=new F,j=new F;function ee(X,se,me){N.setFromMatrixPosition(se.matrixWorld),j.setFromMatrixPosition(me.matrixWorld);const ue=N.distanceTo(j),Ae=se.projectionMatrix.elements,Ce=me.projectionMatrix.elements,Ie=Ae[14]/(Ae[10]-1),Xe=Ae[14]/(Ae[10]+1),Ve=(Ae[9]+1)/Ae[5],Qe=(Ae[9]-1)/Ae[5],_t=(Ae[8]-1)/Ae[0],Ct=(Ce[8]+1)/Ce[0],Gt=Ie*_t,je=Ie*Ct,xt=ue/(-_t+Ct),vt=xt*-_t;if(se.matrixWorld.decompose(X.position,X.quaternion,X.scale),X.translateX(vt),X.translateZ(xt),X.matrixWorld.compose(X.position,X.quaternion,X.scale),X.matrixWorldInverse.copy(X.matrixWorld).invert(),Ae[10]===-1)X.projectionMatrix.copy(se.projectionMatrix),X.projectionMatrixInverse.copy(se.projectionMatrixInverse);else{const mt=Ie+xt,L=Xe+xt,kt=Gt-vt,qe=je+(ue-vt),et=Ve*Xe/L*mt,S=Qe*Xe/L*mt;X.projectionMatrix.makePerspective(kt,qe,et,S,mt,L),X.projectionMatrixInverse.copy(X.projectionMatrix).invert()}}function ne(X,se){se===null?X.matrixWorld.copy(X.matrix):X.matrixWorld.multiplyMatrices(se.matrixWorld,X.matrix),X.matrixWorldInverse.copy(X.matrixWorld).invert()}this.updateCamera=function(X){if(n===null)return;let se=X.near,me=X.far;M.texture!==null&&(M.depthNear>0&&(se=M.depthNear),M.depthFar>0&&(me=M.depthFar)),b.near=E.near=v.near=se,b.far=E.far=v.far=me,(z!==b.near||H!==b.far)&&(n.updateRenderState({depthNear:b.near,depthFar:b.far}),z=b.near,H=b.far),b.layers.mask=X.layers.mask|6,v.layers.mask=b.layers.mask&-5,E.layers.mask=b.layers.mask&-3;const ue=X.parent,Ae=b.cameras;ne(b,ue);for(let Ce=0;Ce<Ae.length;Ce++)ne(Ae[Ce],ue);Ae.length===2?ee(b,v,E):b.projectionMatrix.copy(v.projectionMatrix),fe(X,b,ue)};function fe(X,se,me){me===null?X.matrix.copy(se.matrixWorld):(X.matrix.copy(me.matrixWorld),X.matrix.invert(),X.matrix.multiply(se.matrixWorld)),X.matrix.decompose(X.position,X.quaternion,X.scale),X.updateMatrixWorld(!0),X.projectionMatrix.copy(se.projectionMatrix),X.projectionMatrixInverse.copy(se.projectionMatrixInverse),X.isPerspectiveCamera&&(X.fov=xn*2*Math.atan(1/X.projectionMatrix.elements[5]),X.zoom=1)}this.getCamera=function(){return b},this.getFoveation=function(){if(!(f===null&&h===null))return o},this.setFoveation=function(X){o=X,f!==null&&(f.fixedFoveation=X),h!==null&&h.fixedFoveation!==void 0&&(h.fixedFoveation=X)},this.hasDepthSensing=function(){return M.texture!==null},this.getDepthSensingMesh=function(){return M.getMesh(b)},this.getCameraTexture=function(X){return m[X]};let ye=null;function tt(X,se){if(l=se.getViewerPose(c||s),d=se,l!==null){const me=l.views;h!==null&&(e.setRenderTargetFramebuffer(w,h.framebuffer),e.setRenderTarget(w));let ue=!1;me.length!==b.cameras.length&&(b.cameras.length=0,ue=!0);for(let Ce=0;Ce<me.length;Ce++){const Ie=me[Ce];let Xe=null;if(h!==null)Xe=h.getViewport(Ie);else{const Qe=u.getViewSubImage(f,Ie);Xe=Qe.viewport,Ce===0&&(e.setRenderTargetTextures(w,Qe.colorTexture,Qe.depthStencilTexture),e.setRenderTarget(w))}let Ve=W[Ce];Ve===void 0&&(Ve=new Yt,Ve.layers.enable(Ce),Ve.viewport=new nt,W[Ce]=Ve),Ve.matrix.fromArray(Ie.transform.matrix),Ve.matrix.decompose(Ve.position,Ve.quaternion,Ve.scale),Ve.projectionMatrix.fromArray(Ie.projectionMatrix),Ve.projectionMatrixInverse.copy(Ve.projectionMatrix).invert(),Ve.viewport.set(Xe.x,Xe.y,Xe.width,Xe.height),Ce===0&&(b.matrix.copy(Ve.matrix),b.matrix.decompose(b.position,b.quaternion,b.scale)),ue===!0&&b.cameras.push(Ve)}const Ae=n.enabledFeatures;if(Ae&&Ae.includes("depth-sensing")&&n.depthUsage=="gpu-optimized"&&_){u=i.getBinding();const Ce=u.getDepthInformation(me[0]);Ce&&Ce.isValid&&Ce.texture&&M.init(Ce,n.renderState)}if(Ae&&Ae.includes("camera-access")&&_){e.state.unbindTexture(),u=i.getBinding();for(let Ce=0;Ce<me.length;Ce++){const Ie=me[Ce].camera;if(Ie){let Xe=m[Ie];Xe||(Xe=new Sa,m[Ie]=Xe);const Ve=u.getCameraImage(Ie);Xe.sourceTexture=Ve}}}}for(let me=0;me<y.length;me++){const ue=A[me],Ae=y[me];ue!==null&&Ae!==void 0&&Ae.update(ue,se,c||s)}ye&&ye(X,se),se.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:se}),d=null}const Ze=new Ia;Ze.setAnimationLoop(tt),this.setAnimationLoop=function(X){ye=X},this.dispose=function(){}}},Sd=new ot,oo=new De;oo.set(-1,0,0,0,1,0,0,0,1);function yd(e,t){function i(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function n(m,p){p.color.getRGB(m.fogColor.value,Ea(e)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function r(m,p,T,w,y){p.isNodeMaterial?p.uniformsNeedUpdate=!1:p.isMeshBasicMaterial?s(m,p):p.isMeshLambertMaterial?(s(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshToonMaterial?(s(m,p),f(m,p)):p.isMeshPhongMaterial?(s(m,p),u(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshStandardMaterial?(s(m,p),h(m,p),p.isMeshPhysicalMaterial&&d(m,p,y)):p.isMeshMatcapMaterial?(s(m,p),_(m,p)):p.isMeshDepthMaterial?s(m,p):p.isMeshDistanceMaterial?(s(m,p),M(m,p)):p.isMeshNormalMaterial?s(m,p):p.isLineBasicMaterial?(a(m,p),p.isLineDashedMaterial&&o(m,p)):p.isPointsMaterial?c(m,p,T,w):p.isSpriteMaterial?l(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function s(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,i(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,i(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,i(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===1&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,i(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===1&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,i(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,i(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,i(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);const T=t.get(p),w=T.envMap,y=T.envMapRotation;w&&(m.envMap.value=w,m.envMapRotation.value.setFromMatrix4(Sd.makeRotationFromEuler(y)).transpose(),w.isCubeTexture&&w.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(oo),m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,i(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,i(p.aoMap,m.aoMapTransform))}function a(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,i(p.map,m.mapTransform))}function o(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function c(m,p,T,w){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*T,m.scale.value=w*.5,p.map&&(m.map.value=p.map,i(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,i(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function l(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,i(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,i(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function u(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function f(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function h(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,i(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,i(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function d(m,p,T){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,i(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,i(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,i(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,i(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,i(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===1&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,i(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,i(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=T.texture,m.transmissionSamplerSize.value.set(T.width,T.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,i(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,i(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,i(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,i(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,i(p.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,p){p.matcap&&(m.matcap.value=p.matcap)}function M(m,p){const T=t.get(p).light;m.referencePosition.value.setFromMatrixPosition(T.matrixWorld),m.nearDistance.value=T.shadow.camera.near,m.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function Ed(e,t,i,n){let r={},s={},a=[];const o=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(y,A){const R=A.program;n.uniformBlockBinding(y,R)}function l(y,A){let R=r[y.id];R===void 0&&(m(y),R=u(y),r[y.id]=R,y.addEventListener("dispose",T));const P=A.program;n.updateUBOMapping(y,P);const v=t.render.frame;s[y.id]!==v&&(h(y),s[y.id]=v)}function u(y){const A=f();y.__bindingPointIndex=A;const R=e.createBuffer(),P=y.__size,v=y.usage;return e.bindBuffer(e.UNIFORM_BUFFER,R),e.bufferData(e.UNIFORM_BUFFER,P,v),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,A,R),R}function f(){for(let y=0;y<o;y++)if(a.indexOf(y)===-1)return a.push(y),y;return Re("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(y){const A=r[y.id],R=y.uniforms,P=y.__cache;e.bindBuffer(e.UNIFORM_BUFFER,A);for(let v=0,E=R.length;v<E;v++){const W=R[v];if(Array.isArray(W))for(let b=0,z=W.length;b<z;b++)d(W[b],v,b,P);else d(W,v,0,P)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function d(y,A,R,P){if(M(y,A,R,P)===!0){const v=y.__offset,E=y.value;if(Array.isArray(E)){let W=0;for(let b=0;b<E.length;b++){const z=E[b],H=p(z);_(z,y.__data,W),typeof z!="number"&&typeof z!="boolean"&&!z.isMatrix3&&!ArrayBuffer.isView(z)&&(W+=H.storage/Float32Array.BYTES_PER_ELEMENT)}}else _(E,y.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,v,y.__data)}}function _(y,A,R){typeof y=="number"||typeof y=="boolean"?A[0]=y:y.isMatrix3?(A[0]=y.elements[0],A[1]=y.elements[1],A[2]=y.elements[2],A[3]=0,A[4]=y.elements[3],A[5]=y.elements[4],A[6]=y.elements[5],A[7]=0,A[8]=y.elements[6],A[9]=y.elements[7],A[10]=y.elements[8],A[11]=0):ArrayBuffer.isView(y)?A.set(new y.constructor(y.buffer,y.byteOffset,A.length)):y.toArray(A,R)}function M(y,A,R,P){const v=y.value,E=A+"_"+R;if(P[E]===void 0)return typeof v=="number"||typeof v=="boolean"?P[E]=v:ArrayBuffer.isView(v)?P[E]=v.slice():P[E]=v.clone(),!0;{const W=P[E];if(typeof v=="number"||typeof v=="boolean"){if(W!==v)return P[E]=v,!0}else{if(ArrayBuffer.isView(v))return!0;if(W.equals(v)===!1)return W.copy(v),!0}}return!1}function m(y){const A=y.uniforms;let R=0;const P=16;for(let E=0,W=A.length;E<W;E++){const b=Array.isArray(A[E])?A[E]:[A[E]];for(let z=0,H=b.length;z<H;z++){const Y=b[z],k=Array.isArray(Y.value)?Y.value:[Y.value];for(let K=0,N=k.length;K<N;K++){const j=k[K],ee=p(j),ne=R%P,fe=ne%ee.boundary,ye=ne+fe;R+=fe,ye!==0&&P-ye<ee.storage&&(R+=P-ye),Y.__data=new Float32Array(ee.storage/Float32Array.BYTES_PER_ELEMENT),Y.__offset=R,R+=ee.storage}}}const v=R%P;return v>0&&(R+=P-v),y.__size=R,y.__cache={},this}function p(y){const A={boundary:0,storage:0};return typeof y=="number"||typeof y=="boolean"?(A.boundary=4,A.storage=4):y.isVector2?(A.boundary=8,A.storage=8):y.isVector3||y.isColor?(A.boundary=16,A.storage=12):y.isVector4?(A.boundary=16,A.storage=16):y.isMatrix3?(A.boundary=48,A.storage=48):y.isMatrix4?(A.boundary=64,A.storage=64):y.isTexture?Te("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(y)?(A.boundary=16,A.storage=y.byteLength):Te("WebGLRenderer: Unsupported uniform value type.",y),A}function T(y){const A=y.target;A.removeEventListener("dispose",T);const R=a.indexOf(A.__bindingPointIndex);a.splice(R,1),e.deleteBuffer(r[A.id]),delete r[A.id],delete s[A.id]}function w(){for(const y in r)e.deleteBuffer(r[y]);a=[],r={},s={}}return{bind:c,update:l,dispose:w}}var bd=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),ni=null;function Td(){return ni===null&&(ni=new Sc(bd,16,16,zn,wi),ni.name="DFG_LUT",ni.minFilter=Pt,ni.magFilter=Pt,ni.wrapS=ai,ni.wrapT=ai,ni.generateMipmaps=!1,ni.needsUpdate=!0),ni}var Ad=class{constructor(e={}){const{canvas:t=Nl(),context:i=null,depth:n=!0,stencil:r=!1,alpha:s=!1,antialias:a=!1,premultipliedAlpha:o=!0,preserveDrawingBuffer:c=!1,powerPreference:l="default",failIfMajorPerformanceCaveat:u=!1,reversedDepthBuffer:f=!1,outputBufferType:h=pi}=e;this.isWebGLRenderer=!0;let d;if(i!==null){if(typeof WebGLRenderingContext!="undefined"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");d=i.getContextAttributes().alpha}else d=s;const _=h,M=new Set([Xs,Ws,Hs]),m=new Set([pi,Ai,Bs,Gs,zs,Vs]),p=new Uint32Array(4),T=new Int32Array(4),w=new F;let y=null,A=null;const R=[],P=[];let v=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const E=this;let W=!1,b=null,z=null,H=null,Y=null;this._outputColorSpace=It;let k=0,K=0,N=null,j=-1,ee=null;const ne=new nt,fe=new nt;let ye=null;const tt=new Oe(0);let Ze=0,X=t.width,se=t.height,me=1,ue=null,Ae=null;const Ce=new nt(0,0,X,se),Ie=new nt(0,0,X,se);let Xe=!1;const Ve=new ls;let Qe=!1,_t=!1;const Ct=new ot,Gt=new F,je=new nt,xt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let vt=!1;function mt(){return N===null?me:1}let L=i;function kt(x,U){return t.getContext(x,U)}try{const x={alpha:!0,depth:n,stencil:r,antialias:a,premultipliedAlpha:o,preserveDrawingBuffer:c,powerPreference:l,failIfMajorPerformanceCaveat:u};if("setAttribute"in t&&t.setAttribute("data-engine","three.js r185"),t.addEventListener("webglcontextlost",we,!1),t.addEventListener("webglcontextrestored",Rt,!1),t.addEventListener("webglcontextcreationerror",$e,!1),L===null){const U="webgl2";if(L=kt(U,x),L===null)throw kt(U)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(x){throw Re("WebGLRenderer: "+x.message),x}let qe,et,S,g,C,G,Z,ie,le,D,te,pe,xe,Q,Se,Ee,Le,ke,I,q,$,de,_e;function J(){qe=new Th(L),qe.init(),$=new gd(L,qe),et=new vh(L,qe,e,$),S=new pd(L,qe),et.reversedDepthBuffer&&f&&S.buffers.depth.setReversed(!0),z=L.createFramebuffer(),H=L.createFramebuffer(),Y=L.createFramebuffer(),g=new Rh(L),C=new ed,G=new md(L,qe,S,C,et,$,g),Z=new bh(E),ie=new dh(L),de=new mh(L,ie),le=new Ah(L,ie,g,de),D=new Ph(L,le,ie,de,g),ke=new Ch(L,et,G),Se=new _h(C),te=new ju(E,Z,qe,et,de,Se),pe=new yd(E,C),xe=new id,Q=new ld(qe),Le=new ph(E,Z,S,D,d,o),Ee=new fd(E,D,et),_e=new Ed(L,g,et,S),I=new gh(L,qe,g),q=new wh(L,qe,g),g.programs=te.programs,E.capabilities=et,E.extensions=qe,E.properties=C,E.renderLists=xe,E.shadowMap=Ee,E.state=S,E.info=g}J(),_!==1009&&(v=new Lh(_,t.width,t.height,a,n,r));const ce=new Md(E,L);this.xr=ce,this.getContext=function(){return L},this.getContextAttributes=function(){return L.getContextAttributes()},this.forceContextLoss=function(){const x=qe.get("WEBGL_lose_context");x&&x.loseContext()},this.forceContextRestore=function(){const x=qe.get("WEBGL_lose_context");x&&x.restoreContext()},this.getPixelRatio=function(){return me},this.setPixelRatio=function(x){x!==void 0&&(me=x,this.setSize(X,se,!1))},this.getSize=function(x){return x.set(X,se)},this.setSize=function(x,U,V=!0){if(ce.isPresenting){Te("WebGLRenderer: Can't change size while VR device is presenting.");return}X=x,se=U,t.width=Math.floor(x*me),t.height=Math.floor(U*me),V===!0&&(t.style.width=x+"px",t.style.height=U+"px"),v!==null&&v.setSize(t.width,t.height),this.setViewport(0,0,x,U)},this.getDrawingBufferSize=function(x){return x.set(X*me,se*me).floor()},this.setDrawingBufferSize=function(x,U,V){X=x,se=U,me=V,t.width=Math.floor(x*V),t.height=Math.floor(U*V),this.setViewport(0,0,x,U)},this.setEffects=function(x){if(_===1009){Re("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(x){for(let U=0;U<x.length;U++)if(x[U].isOutputPass===!0){Te("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}v.setEffects(x||[])},this.getCurrentViewport=function(x){return x.copy(ne)},this.getViewport=function(x){return x.copy(Ce)},this.setViewport=function(x,U,V,B){x.isVector4?Ce.set(x.x,x.y,x.z,x.w):Ce.set(x,U,V,B),S.viewport(ne.copy(Ce).multiplyScalar(me).round())},this.getScissor=function(x){return x.copy(Ie)},this.setScissor=function(x,U,V,B){x.isVector4?Ie.set(x.x,x.y,x.z,x.w):Ie.set(x,U,V,B),S.scissor(fe.copy(Ie).multiplyScalar(me).round())},this.getScissorTest=function(){return Xe},this.setScissorTest=function(x){S.setScissorTest(Xe=x)},this.setOpaqueSort=function(x){ue=x},this.setTransparentSort=function(x){Ae=x},this.getClearColor=function(x){return x.copy(Le.getClearColor())},this.setClearColor=function(){Le.setClearColor(...arguments)},this.getClearAlpha=function(){return Le.getClearAlpha()},this.setClearAlpha=function(){Le.setClearAlpha(...arguments)},this.clear=function(x=!0,U=!0,V=!0){let B=0;if(x){let O=!1;if(N!==null){const re=N.texture.format;O=M.has(re)}if(O){const re=N.texture.type,he=m.has(re),ge=Le.getClearColor(),ve=Le.getClearAlpha(),Pe=ge.r,Ne=ge.g,Fe=ge.b;he?(p[0]=Pe,p[1]=Ne,p[2]=Fe,p[3]=ve,L.clearBufferuiv(L.COLOR,0,p)):(T[0]=Pe,T[1]=Ne,T[2]=Fe,T[3]=ve,L.clearBufferiv(L.COLOR,0,T))}else B|=L.COLOR_BUFFER_BIT}U&&(B|=L.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),V&&(B|=L.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),B!==0&&L.clear(B)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(x){x.setRenderer(this),b=x},this.dispose=function(){t.removeEventListener("webglcontextlost",we,!1),t.removeEventListener("webglcontextrestored",Rt,!1),t.removeEventListener("webglcontextcreationerror",$e,!1),Le.dispose(),xe.dispose(),Q.dispose(),C.dispose(),Z.dispose(),D.dispose(),de.dispose(),_e.dispose(),te.dispose(),ce.dispose(),ce.removeEventListener("sessionstart",yo),ce.removeEventListener("sessionend",Eo),Oi.stop()};function we(x){x.preventDefault(),Js("WebGLRenderer: Context Lost."),W=!0}function Rt(){Js("WebGLRenderer: Context Restored."),W=!1;const x=g.autoReset,U=Ee.enabled,V=Ee.autoUpdate,B=Ee.needsUpdate,O=Ee.type;J(),g.autoReset=x,Ee.enabled=U,Ee.autoUpdate=V,Ee.needsUpdate=B,Ee.type=O}function $e(x){Re("WebGLRenderer: A WebGL context could not be created. Reason: ",x.statusMessage)}function ri(x){const U=x.target;U.removeEventListener("dispose",ri),fi(U)}function fi(x){lf(x),C.remove(x)}function lf(x){const U=C.get(x).programs;U!==void 0&&(U.forEach(function(V){te.releaseProgram(V)}),x.isShaderMaterial&&te.releaseShaderCache(x))}this.renderBufferDirect=function(x,U,V,B,O,re){U===null&&(U=xt);const he=O.isMesh&&O.matrixWorld.determinantAffine()<0,ge=uf(x,U,V,B,O);S.setMaterial(B,he);let ve=V.index,Pe=1;if(B.wireframe===!0){if(ve=le.getWireframeAttribute(V),ve===void 0)return;Pe=2}const Ne=V.drawRange,Fe=V.attributes.position;let be=Ne.start*Pe,Je=(Ne.start+Ne.count)*Pe;re!==null&&(be=Math.max(be,re.start*Pe),Je=Math.min(Je,(re.start+re.count)*Pe)),ve!==null?(be=Math.max(be,0),Je=Math.min(Je,ve.count)):Fe!=null&&(be=Math.max(be,0),Je=Math.min(Je,Fe.count));const st=Je-be;if(st<0||st===1/0)return;de.setup(O,B,ge,V,ve);let at,He=I;if(ve!==null&&(at=ie.get(ve),He=q,He.setIndex(at)),O.isMesh)B.wireframe===!0?(S.setLineWidth(B.wireframeLinewidth*mt()),He.setMode(L.LINES)):He.setMode(L.TRIANGLES);else if(O.isLine){let Et=B.linewidth;Et===void 0&&(Et=1),S.setLineWidth(Et*mt()),O.isLineSegments?He.setMode(L.LINES):O.isLineLoop?He.setMode(L.LINE_LOOP):He.setMode(L.LINE_STRIP)}else O.isPoints?He.setMode(L.POINTS):O.isSprite&&He.setMode(L.TRIANGLES);if(O.isBatchedMesh)if(qe.get("WEBGL_multi_draw"))He.renderMultiDraw(O._multiDrawStarts,O._multiDrawCounts,O._multiDrawCount);else{const Et=O._multiDrawStarts,Me=O._multiDrawCounts,Zt=O._multiDrawCount,We=ve?ie.get(ve).bytesPerElement:1,Ht=C.get(B).currentProgram.getUniforms();for(let si=0;si<Zt;si++)Ht.setValue(L,"_gl_DrawID",si),He.render(Et[si]/We,Me[si])}else if(O.isInstancedMesh)He.renderInstances(be,st,O.count);else if(V.isInstancedBufferGeometry){const Et=V._maxInstanceCount!==void 0?V._maxInstanceCount:1/0,Me=Math.min(V.instanceCount,Et);He.renderInstances(be,st,Me)}else He.render(be,st)};function So(x,U,V){x.transparent===!0&&x.side===2&&x.forceSinglePass===!1?(x.side=1,x.needsUpdate=!0,Ar(x,U,V),x.side=0,x.needsUpdate=!0,Ar(x,U,V),x.side=2):Ar(x,U,V)}this.compile=function(x,U,V=null){V===null&&(V=x),A=Q.get(V),A.init(U),P.push(A),V.traverseVisible(function(O){O.isLight&&O.layers.test(U.layers)&&(A.pushLight(O),O.castShadow&&A.pushShadow(O))}),x!==V&&x.traverseVisible(function(O){O.isLight&&O.layers.test(U.layers)&&(A.pushLight(O),O.castShadow&&A.pushShadow(O))}),A.setupLights();const B=new Set;return x.traverse(function(O){if(!(O.isMesh||O.isPoints||O.isLine||O.isSprite))return;const re=O.material;if(re)if(Array.isArray(re))for(let he=0;he<re.length;he++){const ge=re[he];So(ge,V,O),B.add(ge)}else So(re,V,O),B.add(re)}),A=P.pop(),B},this.compileAsync=function(x,U,V=null){const B=this.compile(x,U,V);return new Promise(O=>{function re(){if(B.forEach(function(he){C.get(he).currentProgram.isReady()&&B.delete(he)}),B.size===0){O(x);return}setTimeout(re,10)}qe.get("KHR_parallel_shader_compile")!==null?re():setTimeout(re,10)})};let Ts=null;function cf(x){Ts&&Ts(x)}function yo(){Oi.stop()}function Eo(){Oi.start()}const Oi=new Ia;Oi.setAnimationLoop(cf),typeof self!="undefined"&&Oi.setContext(self),this.setAnimationLoop=function(x){Ts=x,ce.setAnimationLoop(x),x===null?Oi.stop():Oi.start()},ce.addEventListener("sessionstart",yo),ce.addEventListener("sessionend",Eo),this.render=function(x,U){if(U!==void 0&&U.isCamera!==!0){Re("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(W===!0)return;b!==null&&b.renderStart(x,U);const V=ce.enabled===!0&&ce.isPresenting===!0,B=v!==null&&(N===null||V)&&v.begin(E,N);if(x.matrixWorldAutoUpdate===!0&&x.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),ce.enabled===!0&&ce.isPresenting===!0&&(v===null||v.isCompositing()===!1)&&(ce.cameraAutoUpdate===!0&&ce.updateCamera(U),U=ce.getCamera()),x.isScene===!0&&x.onBeforeRender(E,x,U,N),A=Q.get(x,P.length),A.init(U),A.state.textureUnits=G.getTextureUnits(),P.push(A),Ct.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),Ve.setFromProjectionMatrix(Ct,Bi,U.reversedDepth),_t=this.localClippingEnabled,Qe=Se.init(this.clippingPlanes,_t),y=xe.get(x,R.length),y.init(),R.push(y),ce.enabled===!0&&ce.isPresenting===!0){const re=E.xr.getDepthSensingMesh();re!==null&&As(re,U,-1/0,E.sortObjects)}As(x,U,0,E.sortObjects),y.finish(),E.sortObjects===!0&&y.sort(ue,Ae,U.reversedDepth),vt=ce.enabled===!1||ce.isPresenting===!1||ce.hasDepthSensing()===!1,vt&&Le.addToRenderList(y,x),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Qe===!0&&Se.beginShadows();const O=A.state.shadowsArray;if(Ee.render(O,x,U),Qe===!0&&Se.endShadows(),(B&&v.hasRenderPass())===!1){const re=y.opaque,he=y.transmissive;if(A.setupLights(),U.isArrayCamera){const ge=U.cameras;if(he.length>0)for(let ve=0,Pe=ge.length;ve<Pe;ve++){const Ne=ge[ve];To(re,he,x,Ne)}vt&&Le.render(x);for(let ve=0,Pe=ge.length;ve<Pe;ve++){const Ne=ge[ve];bo(y,x,Ne,Ne.viewport)}}else he.length>0&&To(re,he,x,U),vt&&Le.render(x),bo(y,x,U)}N!==null&&K===0&&(G.updateMultisampleRenderTarget(N),G.updateRenderTargetMipmap(N)),B&&v.end(E),x.isScene===!0&&x.onAfterRender(E,x,U),de.resetDefaultState(),j=-1,ee=null,P.pop(),P.length>0?(A=P[P.length-1],G.setTextureUnits(A.state.textureUnits),Qe===!0&&Se.setGlobalState(E.clippingPlanes,A.state.camera)):A=null,R.pop(),R.length>0?y=R[R.length-1]:y=null,b!==null&&b.renderEnd()};function As(x,U,V,B){if(x.visible===!1)return;if(x.layers.test(U.layers)){if(x.isGroup)V=x.renderOrder;else if(x.isLOD)x.autoUpdate===!0&&x.update(U);else if(x.isLightProbeGrid)A.pushLightProbeGrid(x);else if(x.isLight)A.pushLight(x),x.castShadow&&A.pushShadow(x);else if(x.isSprite){if(!x.frustumCulled||Ve.intersectsSprite(x)){B&&je.setFromMatrixPosition(x.matrixWorld).applyMatrix4(Ct);const re=D.update(x),he=x.material;he.visible&&y.push(x,re,he,V,je.z,null)}}else if((x.isMesh||x.isLine||x.isPoints)&&(!x.frustumCulled||Ve.intersectsObject(x))){const re=D.update(x),he=x.material;if(B&&(x.boundingSphere!==void 0?(x.boundingSphere===null&&x.computeBoundingSphere(),je.copy(x.boundingSphere.center)):(re.boundingSphere===null&&re.computeBoundingSphere(),je.copy(re.boundingSphere.center)),je.applyMatrix4(x.matrixWorld).applyMatrix4(Ct)),Array.isArray(he)){const ge=re.groups;for(let ve=0,Pe=ge.length;ve<Pe;ve++){const Ne=ge[ve],Fe=he[Ne.materialIndex];Fe&&Fe.visible&&y.push(x,re,Fe,V,je.z,Ne)}}else he.visible&&y.push(x,re,he,V,je.z,null)}}const O=x.children;for(let re=0,he=O.length;re<he;re++)As(O[re],U,V,B)}function bo(x,U,V,B){const{opaque:O,transmissive:re,transparent:he}=x;A.setupLightsView(V),Qe===!0&&Se.setGlobalState(E.clippingPlanes,V),B&&S.viewport(ne.copy(B)),O.length>0&&Tr(O,U,V),re.length>0&&Tr(re,U,V),he.length>0&&Tr(he,U,V),S.buffers.depth.setTest(!0),S.buffers.depth.setMask(!0),S.buffers.color.setMask(!0),S.setPolygonOffset(!1)}function To(x,U,V,B){if((V.isScene===!0?V.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[B.id]===void 0){const Fe=qe.has("EXT_color_buffer_half_float")||qe.has("EXT_color_buffer_float");A.state.transmissionRenderTarget[B.id]=new Jt(1,1,{generateMipmaps:!0,type:Fe?wi:pi,minFilter:Lr,samples:Math.max(4,et.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ze.workingColorSpace})}const O=A.state.transmissionRenderTarget[B.id],re=B.viewport||ne;O.setSize(re.z*E.transmissionResolutionScale,re.w*E.transmissionResolutionScale);const he=E.getRenderTarget(),ge=E.getActiveCubeFace(),ve=E.getActiveMipmapLevel();E.setRenderTarget(O),E.getClearColor(tt),Ze=E.getClearAlpha(),Ze<1&&E.setClearColor(16777215,.5),E.clear(),vt&&Le.render(V);const Pe=E.toneMapping;E.toneMapping=0;const Ne=B.viewport;if(B.viewport!==void 0&&(B.viewport=void 0),A.setupLightsView(B),Qe===!0&&Se.setGlobalState(E.clippingPlanes,B),Tr(x,V,B),G.updateMultisampleRenderTarget(O),G.updateRenderTargetMipmap(O),qe.has("WEBGL_multisampled_render_to_texture")===!1){let Fe=!1;for(let be=0,Je=U.length;be<Je;be++){const{object:st,geometry:at,material:He,group:Et}=U[be];if(He.side===2&&st.layers.test(B.layers)){const Me=He.side;He.side=1,He.needsUpdate=!0,Ao(st,V,B,at,He,Et),He.side=Me,He.needsUpdate=!0,Fe=!0}}Fe===!0&&(G.updateMultisampleRenderTarget(O),G.updateRenderTargetMipmap(O))}E.setRenderTarget(he,ge,ve),E.setClearColor(tt,Ze),Ne!==void 0&&(B.viewport=Ne),E.toneMapping=Pe}function Tr(x,U,V){const B=U.isScene===!0?U.overrideMaterial:null;for(let O=0,re=x.length;O<re;O++){const he=x[O],{object:ge,geometry:ve,group:Pe}=he;let Ne=he.material;Ne.allowOverride===!0&&B!==null&&(Ne=B),ge.layers.test(V.layers)&&Ao(ge,U,V,ve,Ne,Pe)}}function Ao(x,U,V,B,O,re){x.onBeforeRender(E,U,V,B,O,re),x.modelViewMatrix.multiplyMatrices(V.matrixWorldInverse,x.matrixWorld),x.normalMatrix.getNormalMatrix(x.modelViewMatrix),O.onBeforeRender(E,U,V,B,x,re),O.transparent===!0&&O.side===2&&O.forceSinglePass===!1?(O.side=1,O.needsUpdate=!0,E.renderBufferDirect(V,U,B,O,x,re),O.side=0,O.needsUpdate=!0,E.renderBufferDirect(V,U,B,O,x,re),O.side=2):E.renderBufferDirect(V,U,B,O,x,re),x.onAfterRender(E,U,V,B,O,re)}function Ar(x,U,V){U.isScene!==!0&&(U=xt);const B=C.get(x),O=A.state.lights,re=A.state.shadowsArray,he=O.state.version,ge=te.getParameters(x,O.state,re,U,V,A.state.lightProbeGridArray),ve=te.getProgramCacheKey(ge);let Pe=B.programs;B.environment=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?U.environment:null,B.fog=U.fog;const Ne=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap;B.envMap=Z.get(x.envMap||B.environment,Ne),B.envMapRotation=B.environment!==null&&x.envMap===null?U.environmentRotation:x.envMapRotation,Pe===void 0&&(x.addEventListener("dispose",ri),Pe=new Map,B.programs=Pe);let Fe=Pe.get(ve);if(Fe!==void 0){if(B.currentProgram===Fe&&B.lightsStateVersion===he)return Ro(x,ge),Fe}else ge.uniforms=te.getUniforms(x),b!==null&&x.isNodeMaterial&&b.build(x,V,ge),x.onBeforeCompile(ge,E),Fe=te.acquireProgram(ge,ve),Pe.set(ve,Fe),B.uniforms=ge.uniforms;const be=B.uniforms;return(!x.isShaderMaterial&&!x.isRawShaderMaterial||x.clipping===!0)&&(be.clippingPlanes=Se.uniform),Ro(x,ge),B.needsLights=ff(x),B.lightsStateVersion=he,B.needsLights&&(be.ambientLightColor.value=O.state.ambient,be.lightProbe.value=O.state.probe,be.directionalLights.value=O.state.directional,be.directionalLightShadows.value=O.state.directionalShadow,be.spotLights.value=O.state.spot,be.spotLightShadows.value=O.state.spotShadow,be.rectAreaLights.value=O.state.rectArea,be.ltc_1.value=O.state.rectAreaLTC1,be.ltc_2.value=O.state.rectAreaLTC2,be.pointLights.value=O.state.point,be.pointLightShadows.value=O.state.pointShadow,be.hemisphereLights.value=O.state.hemi,be.directionalShadowMatrix.value=O.state.directionalShadowMatrix,be.spotLightMatrix.value=O.state.spotLightMatrix,be.spotLightMap.value=O.state.spotLightMap,be.pointShadowMatrix.value=O.state.pointShadowMatrix),B.lightProbeGrid=A.state.lightProbeGridArray.length>0,B.currentProgram=Fe,B.uniformsList=null,Fe}function wo(x){if(x.uniformsList===null){const U=x.currentProgram.getUniforms();x.uniformsList=vr.seqWithValue(U.seq,x.uniforms)}return x.uniformsList}function Ro(x,U){const V=C.get(x);V.outputColorSpace=U.outputColorSpace,V.batching=U.batching,V.batchingColor=U.batchingColor,V.instancing=U.instancing,V.instancingColor=U.instancingColor,V.instancingMorph=U.instancingMorph,V.skinning=U.skinning,V.morphTargets=U.morphTargets,V.morphNormals=U.morphNormals,V.morphColors=U.morphColors,V.morphTargetsCount=U.morphTargetsCount,V.numClippingPlanes=U.numClippingPlanes,V.numIntersection=U.numClipIntersection,V.vertexAlphas=U.vertexAlphas,V.vertexTangents=U.vertexTangents,V.toneMapping=U.toneMapping}function hf(x,U){if(x.length===0)return null;if(x.length===1)return x[0].texture!==null?x[0]:null;w.setFromMatrixPosition(U.matrixWorld);for(let V=0,B=x.length;V<B;V++){const O=x[V];if(O.texture!==null&&O.boundingBox.containsPoint(w))return O}return null}function uf(x,U,V,B,O){U.isScene!==!0&&(U=xt),G.resetTextureUnits();const re=U.fog,he=B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial?U.environment:null,ge=N===null?E.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:ze.workingColorSpace,ve=B.isMeshStandardMaterial||B.isMeshLambertMaterial&&!B.envMap||B.isMeshPhongMaterial&&!B.envMap,Pe=Z.get(B.envMap||he,ve),Ne=B.vertexColors===!0&&!!V.attributes.color&&V.attributes.color.itemSize===4,Fe=!!V.attributes.tangent&&(!!B.normalMap||B.anisotropy>0),be=!!V.morphAttributes.position,Je=!!V.morphAttributes.normal,st=!!V.morphAttributes.color;let at=0;B.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(at=E.toneMapping);const He=V.morphAttributes.position||V.morphAttributes.normal||V.morphAttributes.color,Et=He!==void 0?He.length:0,Me=C.get(B),Zt=A.state.lights;if(Qe===!0&&(_t===!0||x!==ee)){const Ye=x===ee&&B.id===j;Se.setState(B,x,Ye)}let We=!1;B.version===Me.__version?(Me.needsLights&&Me.lightsStateVersion!==Zt.state.version||Me.outputColorSpace!==ge||O.isBatchedMesh&&Me.batching===!1||!O.isBatchedMesh&&Me.batching===!0||O.isBatchedMesh&&Me.batchingColor===!0&&O.colorTexture===null||O.isBatchedMesh&&Me.batchingColor===!1&&O.colorTexture!==null||O.isInstancedMesh&&Me.instancing===!1||!O.isInstancedMesh&&Me.instancing===!0||O.isSkinnedMesh&&Me.skinning===!1||!O.isSkinnedMesh&&Me.skinning===!0||O.isInstancedMesh&&Me.instancingColor===!0&&O.instanceColor===null||O.isInstancedMesh&&Me.instancingColor===!1&&O.instanceColor!==null||O.isInstancedMesh&&Me.instancingMorph===!0&&O.morphTexture===null||O.isInstancedMesh&&Me.instancingMorph===!1&&O.morphTexture!==null||Me.envMap!==Pe||B.fog===!0&&Me.fog!==re||Me.numClippingPlanes!==void 0&&(Me.numClippingPlanes!==Se.numPlanes||Me.numIntersection!==Se.numIntersection)||Me.vertexAlphas!==Ne||Me.vertexTangents!==Fe||Me.morphTargets!==be||Me.morphNormals!==Je||Me.morphColors!==st||Me.toneMapping!==at||Me.morphTargetsCount!==Et||!!Me.lightProbeGrid!=A.state.lightProbeGridArray.length>0)&&(We=!0):(We=!0,Me.__version=B.version);let Ht=Me.currentProgram;We===!0&&(Ht=Ar(B,U,O),b&&B.isNodeMaterial&&b.onUpdateProgram(B,Ht,Me));let si=!1,bi=!1,un=!1;const Ke=Ht.getUniforms(),ct=Me.uniforms;if(S.useProgram(Ht.program)&&(si=!0,bi=!0,un=!0),B.id!==j&&(j=B.id,bi=!0),Me.needsLights){const Ye=hf(A.state.lightProbeGridArray,O);Me.lightProbeGrid!==Ye&&(Me.lightProbeGrid=Ye,bi=!0)}if(si||ee!==x){S.buffers.depth.getReversed()&&x.reversedDepth!==!0&&(x._reversedDepth=!0,x.updateProjectionMatrix()),Ke.setValue(L,"projectionMatrix",x.projectionMatrix),Ke.setValue(L,"viewMatrix",x.matrixWorldInverse);const Ye=Ke.map.cameraPosition;Ye!==void 0&&Ye.setValue(L,Gt.setFromMatrixPosition(x.matrixWorld)),et.logarithmicDepthBuffer&&Ke.setValue(L,"logDepthBufFC",2/(Math.log(x.far+1)/Math.LN2)),(B.isMeshPhongMaterial||B.isMeshToonMaterial||B.isMeshLambertMaterial||B.isMeshBasicMaterial||B.isMeshStandardMaterial||B.isShaderMaterial)&&Ke.setValue(L,"isOrthographic",x.isOrthographicCamera===!0),ee!==x&&(ee=x,bi=!0,un=!0)}if(Me.needsLights&&(Zt.state.directionalShadowMap.length>0&&Ke.setValue(L,"directionalShadowMap",Zt.state.directionalShadowMap,G),Zt.state.spotShadowMap.length>0&&Ke.setValue(L,"spotShadowMap",Zt.state.spotShadowMap,G),Zt.state.pointShadowMap.length>0&&Ke.setValue(L,"pointShadowMap",Zt.state.pointShadowMap,G)),O.isSkinnedMesh){Ke.setOptional(L,O,"bindMatrix"),Ke.setOptional(L,O,"bindMatrixInverse");const Ye=O.skeleton;Ye&&(Ye.boneTexture===null&&Ye.computeBoneTexture(),Ke.setValue(L,"boneTexture",Ye.boneTexture,G))}O.isBatchedMesh&&(Ke.setOptional(L,O,"batchingTexture"),Ke.setValue(L,"batchingTexture",O._matricesTexture,G),Ke.setOptional(L,O,"batchingIdTexture"),Ke.setValue(L,"batchingIdTexture",O._indirectTexture,G),Ke.setOptional(L,O,"batchingColorTexture"),O._colorsTexture!==null&&Ke.setValue(L,"batchingColorTexture",O._colorsTexture,G));const Ti=V.morphAttributes;if((Ti.position!==void 0||Ti.normal!==void 0||Ti.color!==void 0)&&ke.update(O,V,Ht),(bi||Me.receiveShadow!==O.receiveShadow)&&(Me.receiveShadow=O.receiveShadow,Ke.setValue(L,"receiveShadow",O.receiveShadow)),(B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial)&&B.envMap===null&&U.environment!==null&&(ct.envMapIntensity.value=U.environmentIntensity),ct.dfgLUT!==void 0&&(ct.dfgLUT.value=Td()),bi){if(Ke.setValue(L,"toneMappingExposure",E.toneMappingExposure),Me.needsLights&&df(ct,un),re&&B.fog===!0&&pe.refreshFogUniforms(ct,re),pe.refreshMaterialUniforms(ct,B,me,se,A.state.transmissionRenderTarget[x.id]),Me.needsLights&&Me.lightProbeGrid){const Ye=Me.lightProbeGrid;ct.probesSH.value=Ye.texture,ct.probesMin.value.copy(Ye.boundingBox.min),ct.probesMax.value.copy(Ye.boundingBox.max),ct.probesResolution.value.copy(Ye.resolution)}vr.upload(L,wo(Me),ct,G)}if(B.isShaderMaterial&&B.uniformsNeedUpdate===!0&&(vr.upload(L,wo(Me),ct,G),B.uniformsNeedUpdate=!1),B.isSpriteMaterial&&Ke.setValue(L,"center",O.center),Ke.setValue(L,"modelViewMatrix",O.modelViewMatrix),Ke.setValue(L,"normalMatrix",O.normalMatrix),Ke.setValue(L,"modelMatrix",O.matrixWorld),B.uniformsGroups!==void 0){const Ye=B.uniformsGroups;for(let Fn=0,dn=Ye.length;Fn<dn;Fn++){const Co=Ye[Fn];_e.update(Co,Ht),_e.bind(Co,Ht)}}return Ht}function df(x,U){x.ambientLightColor.needsUpdate=U,x.lightProbe.needsUpdate=U,x.directionalLights.needsUpdate=U,x.directionalLightShadows.needsUpdate=U,x.pointLights.needsUpdate=U,x.pointLightShadows.needsUpdate=U,x.spotLights.needsUpdate=U,x.spotLightShadows.needsUpdate=U,x.rectAreaLights.needsUpdate=U,x.hemisphereLights.needsUpdate=U}function ff(x){return x.isMeshLambertMaterial||x.isMeshToonMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isShadowMaterial||x.isShaderMaterial&&x.lights===!0}this.getActiveCubeFace=function(){return k},this.getActiveMipmapLevel=function(){return K},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(x,U,V){const B=C.get(x);B.__autoAllocateDepthBuffer=x.resolveDepthBuffer===!1,B.__autoAllocateDepthBuffer===!1&&(B.__useRenderToTexture=!1),C.get(x.texture).__webglTexture=U,C.get(x.depthTexture).__webglTexture=B.__autoAllocateDepthBuffer?void 0:V,B.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(x,U){const V=C.get(x);V.__webglFramebuffer=U,V.__useDefaultFramebuffer=U===void 0},this.setRenderTarget=function(x,U=0,V=0){N=x,k=U,K=V;let B=null,O=!1,re=!1;if(x){const he=C.get(x);if(he.__useDefaultFramebuffer!==void 0){S.bindFramebuffer(L.FRAMEBUFFER,he.__webglFramebuffer),ne.copy(x.viewport),fe.copy(x.scissor),ye=x.scissorTest,S.viewport(ne),S.scissor(fe),S.setScissorTest(ye),j=-1;return}else if(he.__webglFramebuffer===void 0)G.setupRenderTarget(x);else if(he.__hasExternalTextures)G.rebindTextures(x,C.get(x.texture).__webglTexture,C.get(x.depthTexture).__webglTexture);else if(x.depthBuffer){const Pe=x.depthTexture;if(he.__boundDepthTexture!==Pe){if(Pe!==null&&C.has(Pe)&&(x.width!==Pe.image.width||x.height!==Pe.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");G.setupDepthRenderbuffer(x)}}const ge=x.texture;(ge.isData3DTexture||ge.isDataArrayTexture||ge.isCompressedArrayTexture)&&(re=!0);const ve=C.get(x).__webglFramebuffer;x.isWebGLCubeRenderTarget?(Array.isArray(ve[U])?B=ve[U][V]:B=ve[U],O=!0):x.samples>0&&G.useMultisampledRTT(x)===!1?B=C.get(x).__webglMultisampledFramebuffer:Array.isArray(ve)?B=ve[V]:B=ve,ne.copy(x.viewport),fe.copy(x.scissor),ye=x.scissorTest}else ne.copy(Ce).multiplyScalar(me).floor(),fe.copy(Ie).multiplyScalar(me).floor(),ye=Xe;if(V!==0&&(B=z),S.bindFramebuffer(L.FRAMEBUFFER,B)&&S.drawBuffers(x,B),S.viewport(ne),S.scissor(fe),S.setScissorTest(ye),O){const he=C.get(x.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_CUBE_MAP_POSITIVE_X+U,he.__webglTexture,V)}else if(re){const he=U;for(let ge=0;ge<x.textures.length;ge++){const ve=C.get(x.textures[ge]);L.framebufferTextureLayer(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0+ge,ve.__webglTexture,V,he)}}else if(x!==null&&V!==0){const he=C.get(x.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,he.__webglTexture,V)}j=-1},this.readRenderTargetPixels=function(x,U,V,B,O,re,he,ge=0){if(!(x&&x.isWebGLRenderTarget)){Re("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ve=C.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&he!==void 0&&(ve=ve[he]),ve){S.bindFramebuffer(L.FRAMEBUFFER,ve);try{const Pe=x.textures[ge],Ne=Pe.format,Fe=Pe.type;if(x.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+ge),!et.textureFormatReadable(Ne)){Re("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!et.textureTypeReadable(Fe)){Re("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=x.width-B&&V>=0&&V<=x.height-O&&L.readPixels(U,V,B,O,$.convert(Ne),$.convert(Fe),re)}finally{const Pe=N!==null?C.get(N).__webglFramebuffer:null;S.bindFramebuffer(L.FRAMEBUFFER,Pe)}}},this.readRenderTargetPixelsAsync=async function(x,U,V,B,O,re,he,ge=0){if(!(x&&x.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ve=C.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&he!==void 0&&(ve=ve[he]),ve)if(U>=0&&U<=x.width-B&&V>=0&&V<=x.height-O){S.bindFramebuffer(L.FRAMEBUFFER,ve);const Pe=x.textures[ge],Ne=Pe.format,Fe=Pe.type;if(x.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+ge),!et.textureFormatReadable(Ne))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!et.textureTypeReadable(Fe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const be=L.createBuffer();L.bindBuffer(L.PIXEL_PACK_BUFFER,be),L.bufferData(L.PIXEL_PACK_BUFFER,re.byteLength,L.STREAM_READ),L.readPixels(U,V,B,O,$.convert(Ne),$.convert(Fe),0);const Je=N!==null?C.get(N).__webglFramebuffer:null;S.bindFramebuffer(L.FRAMEBUFFER,Je);const st=L.fenceSync(L.SYNC_GPU_COMMANDS_COMPLETE,0);return L.flush(),await Ol(L,st,4),L.bindBuffer(L.PIXEL_PACK_BUFFER,be),L.getBufferSubData(L.PIXEL_PACK_BUFFER,0,re),L.deleteBuffer(be),L.deleteSync(st),re}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(x,U=null,V=0){const B=Math.pow(2,-V),O=Math.floor(x.image.width*B),re=Math.floor(x.image.height*B),he=U!==null?U.x:0,ge=U!==null?U.y:0;G.setTexture2D(x,0),L.copyTexSubImage2D(L.TEXTURE_2D,V,0,0,he,ge,O,re),S.unbindTexture()},this.copyTextureToTexture=function(x,U,V=null,B=null,O=0,re=0){let he,ge,ve,Pe,Ne,Fe,be,Je,st;const at=x.isCompressedTexture?x.mipmaps[re]:x.image;if(V!==null)he=V.max.x-V.min.x,ge=V.max.y-V.min.y,ve=V.isBox3?V.max.z-V.min.z:1,Pe=V.min.x,Ne=V.min.y,Fe=V.isBox3?V.min.z:0;else{const ct=Math.pow(2,-O);he=Math.floor(at.width*ct),ge=Math.floor(at.height*ct),x.isDataArrayTexture?ve=at.depth:x.isData3DTexture?ve=Math.floor(at.depth*ct):ve=1,Pe=0,Ne=0,Fe=0}B!==null?(be=B.x,Je=B.y,st=B.z):(be=0,Je=0,st=0);const He=$.convert(U.format),Et=$.convert(U.type);let Me;U.isData3DTexture?(G.setTexture3D(U,0),Me=L.TEXTURE_3D):U.isDataArrayTexture||U.isCompressedArrayTexture?(G.setTexture2DArray(U,0),Me=L.TEXTURE_2D_ARRAY):(G.setTexture2D(U,0),Me=L.TEXTURE_2D),S.activeTexture(L.TEXTURE0),S.pixelStorei(L.UNPACK_FLIP_Y_WEBGL,U.flipY),S.pixelStorei(L.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),S.pixelStorei(L.UNPACK_ALIGNMENT,U.unpackAlignment);const Zt=S.getParameter(L.UNPACK_ROW_LENGTH),We=S.getParameter(L.UNPACK_IMAGE_HEIGHT),Ht=S.getParameter(L.UNPACK_SKIP_PIXELS),si=S.getParameter(L.UNPACK_SKIP_ROWS),bi=S.getParameter(L.UNPACK_SKIP_IMAGES);S.pixelStorei(L.UNPACK_ROW_LENGTH,at.width),S.pixelStorei(L.UNPACK_IMAGE_HEIGHT,at.height),S.pixelStorei(L.UNPACK_SKIP_PIXELS,Pe),S.pixelStorei(L.UNPACK_SKIP_ROWS,Ne),S.pixelStorei(L.UNPACK_SKIP_IMAGES,Fe);const un=x.isDataArrayTexture||x.isData3DTexture,Ke=U.isDataArrayTexture||U.isData3DTexture;if(x.isDepthTexture){const ct=C.get(x),Ti=C.get(U),Ye=C.get(ct.__renderTarget),Fn=C.get(Ti.__renderTarget);S.bindFramebuffer(L.READ_FRAMEBUFFER,Ye.__webglFramebuffer),S.bindFramebuffer(L.DRAW_FRAMEBUFFER,Fn.__webglFramebuffer);for(let dn=0;dn<ve;dn++)un&&(L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,C.get(x).__webglTexture,O,Fe+dn),L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,C.get(U).__webglTexture,re,st+dn)),L.blitFramebuffer(Pe,Ne,he,ge,be,Je,he,ge,L.DEPTH_BUFFER_BIT,L.NEAREST);S.bindFramebuffer(L.READ_FRAMEBUFFER,null),S.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else if(O!==0||x.isRenderTargetTexture||C.has(x)){const ct=C.get(x),Ti=C.get(U);S.bindFramebuffer(L.READ_FRAMEBUFFER,H),S.bindFramebuffer(L.DRAW_FRAMEBUFFER,Y);for(let Ye=0;Ye<ve;Ye++)un?L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,ct.__webglTexture,O,Fe+Ye):L.framebufferTexture2D(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,ct.__webglTexture,O),Ke?L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,Ti.__webglTexture,re,st+Ye):L.framebufferTexture2D(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,Ti.__webglTexture,re),O!==0?L.blitFramebuffer(Pe,Ne,he,ge,be,Je,he,ge,L.COLOR_BUFFER_BIT,L.NEAREST):Ke?L.copyTexSubImage3D(Me,re,be,Je,st+Ye,Pe,Ne,he,ge):L.copyTexSubImage2D(Me,re,be,Je,Pe,Ne,he,ge);S.bindFramebuffer(L.READ_FRAMEBUFFER,null),S.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else Ke?x.isDataTexture||x.isData3DTexture?L.texSubImage3D(Me,re,be,Je,st,he,ge,ve,He,Et,at.data):U.isCompressedArrayTexture?L.compressedTexSubImage3D(Me,re,be,Je,st,he,ge,ve,He,at.data):L.texSubImage3D(Me,re,be,Je,st,he,ge,ve,He,Et,at):x.isDataTexture?L.texSubImage2D(L.TEXTURE_2D,re,be,Je,he,ge,He,Et,at.data):x.isCompressedTexture?L.compressedTexSubImage2D(L.TEXTURE_2D,re,be,Je,at.width,at.height,He,at.data):L.texSubImage2D(L.TEXTURE_2D,re,be,Je,he,ge,He,Et,at);S.pixelStorei(L.UNPACK_ROW_LENGTH,Zt),S.pixelStorei(L.UNPACK_IMAGE_HEIGHT,We),S.pixelStorei(L.UNPACK_SKIP_PIXELS,Ht),S.pixelStorei(L.UNPACK_SKIP_ROWS,si),S.pixelStorei(L.UNPACK_SKIP_IMAGES,bi),re===0&&U.generateMipmaps&&L.generateMipmap(Me),S.unbindTexture()},this.initRenderTarget=function(x){C.get(x).__webglFramebuffer===void 0&&G.setupRenderTarget(x)},this.initTexture=function(x){x.isCubeTexture?G.setTextureCube(x,0):x.isData3DTexture?G.setTexture3D(x,0):x.isDataArrayTexture||x.isCompressedArrayTexture?G.setTexture2DArray(x,0):G.setTexture2D(x,0),S.unbindTexture()},this.resetState=function(){k=0,K=0,N=null,S.reset(),de.reset()},typeof __THREE_DEVTOOLS__!="undefined"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Bi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=ze._getDrawingBufferColorSpace(e),t.unpackColorSpace=ze._getUnpackColorSpace()}},xr=3117008;function wd(e){const t=new pc,i=new Oe(xr),n=new fc(xr,22,38);t.background=i,t.fog=n;const r=new Ad({canvas:e,antialias:!0,alpha:!0,powerPreference:"high-performance",failIfMajorPerformanceCaveat:!1});r.setPixelRatio(Math.min(2,window.devicePixelRatio)),r.outputColorSpace=It,r.toneMapping=4,r.toneMappingExposure=1.08,r.shadowMap.enabled=!0,r.shadowMap.type=1,r.setClearColor(xr,1);const s=6.5,a=new fr(-6.5,s,s,-6.5,1,40);a.position.set(8,6,6),a.lookAt(0,0,0);const o=new gi;o.add(a),o.rotation.set(0,-Math.PI/2,0),t.add(o);const c=new Yc(12380671,13015922,.56);t.add(c);const l=new Jc(16777215,.46);t.add(l);const u=new $c(16775405,1.22);u.position.set(5,14,6),u.castShadow=!0,u.shadow.mapSize.set(1024,1024),u.shadow.camera.left=-9,u.shadow.camera.right=9,u.shadow.camera.bottom=-9,u.shadow.camera.top=9,u.shadow.camera.near=1,u.shadow.camera.far=32,u.shadow.bias=-8e-4,u.shadow.normalBias=.04,t.add(u);const f=new Rc({opacity:.22}),h=new lt(new cr(48,48),f);h.rotation.x=-Math.PI/2,h.position.y=-.82,h.receiveShadow=!0,t.add(h);const d=()=>{var m,p;const T=e.parentElement,w=(m=T==null?void 0:T.clientWidth)!==null&&m!==void 0?m:0,y=(p=T==null?void 0:T.clientHeight)!==null&&p!==void 0?p:0,A=Math.min(w||1/0,y||1/0),R=Math.max(120,Math.floor(Number.isFinite(A)?A:Math.min(650,window.innerWidth)));r.setSize(R,R,!1),e.style.width="100%",e.style.height="100%",e.style.aspectRatio="1 / 1"};return d(),window.addEventListener("resize",d),typeof ResizeObserver!="undefined"&&e.parentElement&&new ResizeObserver(d).observe(e.parentElement),document.addEventListener("dblclick",m=>m.preventDefault()),{scene:t,renderer:r,camera:a,cameraPivot:o,frameBoard:(m,p)=>{const T=Math.max(1,m+p);a.zoom=ea.clamp(12/T,.76,1.35),a.updateProjectionMatrix()},setHighAltitude:m=>{t.background=m?null:i,t.fog=m?null:n,r.setClearColor(xr,m?0:1),h.visible=!m,u.position.set(m?3:5,m?18:14,m?4:6),u.shadow.radius=m?3:1},resize:d}}var Dn=new F;function zt(e,t,i,n,r,s){const a=2*Math.PI*r/4,o=Math.max(s-2*r,0),c=Math.PI/4;Dn.copy(t),Dn[n]=0,Dn.normalize();const l=.5*a/(a+o),u=1-Dn.angleTo(e)/c;return Math.sign(Dn[i])===1?u*l:o/(a+o)+l+l*(1-u)}var Ni=class Fo extends lr{constructor(t=1,i=1,n=1,r=2,s=.1){const a=r*2+1;if(s=Math.min(t/2,i/2,n/2,s),super(1,1,1,a,a,a),this.type="RoundedBoxGeometry",this.parameters={width:t,height:i,depth:n,segments:r,radius:s},a===1)return;const o=this.toNonIndexed();this.index=null,this.attributes.position=o.attributes.position,this.attributes.normal=o.attributes.normal,this.attributes.uv=o.attributes.uv;const c=new F,l=new F,u=new F(t,i,n).divideScalar(2).subScalar(s),f=this.attributes.position.array,h=this.attributes.normal.array,d=this.attributes.uv.array,_=f.length/6,M=new F,m=.5/a;for(let p=0,T=0;p<f.length;p+=3,T+=2)switch(c.fromArray(f,p),l.copy(c),l.x-=Math.sign(l.x)*m,l.y-=Math.sign(l.y)*m,l.z-=Math.sign(l.z)*m,l.normalize(),f[p+0]=u.x*Math.sign(c.x)+l.x*s,f[p+1]=u.y*Math.sign(c.y)+l.y*s,f[p+2]=u.z*Math.sign(c.z)+l.z*s,h[p+0]=l.x,h[p+1]=l.y,h[p+2]=l.z,Math.floor(p/_)){case 0:M.set(1,0,0),d[T+0]=zt(M,l,"z","y",s,n),d[T+1]=1-zt(M,l,"y","z",s,i);break;case 1:M.set(-1,0,0),d[T+0]=1-zt(M,l,"z","y",s,n),d[T+1]=1-zt(M,l,"y","z",s,i);break;case 2:M.set(0,1,0),d[T+0]=1-zt(M,l,"x","z",s,t),d[T+1]=zt(M,l,"z","x",s,n);break;case 3:M.set(0,-1,0),d[T+0]=1-zt(M,l,"x","z",s,t),d[T+1]=1-zt(M,l,"z","x",s,n);break;case 4:M.set(0,0,1),d[T+0]=1-zt(M,l,"x","y",s,t),d[T+1]=1-zt(M,l,"y","x",s,i);break;case 5:M.set(0,0,-1),d[T+0]=zt(M,l,"x","y",s,t),d[T+1]=1-zt(M,l,"y","x",s,i)}}static fromJSON(t){return new Fo(t.width,t.height,t.depth,t.segments,t.radius)}};function Ms(){return typeof window!="undefined"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function wt(e){return Ms()?Math.min(70,e):e}function it(e){return{col:e.col,row:e.row,ori:e.ori}}function Vt(e){return e.ori==="standing"?[{col:e.col,row:e.row}]:e.ori==="flatX"?[{col:e.col,row:e.row},{col:e.col+1,row:e.row}]:[{col:e.col,row:e.row},{col:e.col,row:e.row+1}]}function Rd(e,t){const{col:i,row:n,ori:r}=e;return r==="standing"?t==="left"?{col:i-2,row:n,ori:"flatX"}:t==="right"?{col:i+1,row:n,ori:"flatX"}:t==="up"?{col:i,row:n-2,ori:"flatZ"}:{col:i,row:n+1,ori:"flatZ"}:r==="flatX"?t==="left"?{col:i-1,row:n,ori:"standing"}:t==="right"?{col:i+2,row:n,ori:"standing"}:t==="up"?{col:i,row:n-1,ori:"flatX"}:{col:i,row:n+1,ori:"flatX"}:t==="up"?{col:i,row:n-1,ori:"standing"}:t==="down"?{col:i,row:n+2,ori:"standing"}:t==="left"?{col:i-1,row:n,ori:"flatZ"}:{col:i+1,row:n,ori:"flatZ"}}function Cd(e,t){const{col:i,row:n}=e;return t==="left"?{col:i-1,row:n,ori:"standing"}:t==="right"?{col:i+1,row:n,ori:"standing"}:t==="up"?{col:i,row:n-1,ori:"standing"}:{col:i,row:n+1,ori:"standing"}}function Pd(e,t){if(e.ori!=="standing"||t.ori!=="standing")return!1;const i=Math.abs(e.col-t.col),n=Math.abs(e.row-t.row);return i===1&&n===0||i===0&&n===1}function Id(e,t){return e.row===t.row?{col:Math.min(e.col,t.col),row:e.row,ori:"flatX"}:{col:e.col,row:Math.min(e.row,t.row),ori:"flatZ"}}function Ld(e){return e.ori==="standing"?{x:e.col,y:1,z:e.row}:e.ori==="flatX"?{x:e.col+.5,y:.5,z:e.row}:{x:e.col,y:.5,z:e.row+.5}}function lo(e){return e.ori==="standing"?{sx:1,sy:2,sz:1}:e.ori==="flatX"?{sx:2,sy:1,sz:1}:{sx:1,sy:1,sz:2}}function Dd(e){const t=e.length,i=Math.max(...e.map(n=>n.length),1);return{grid:e.map(n=>{const r=n.split("");for(;r.length<i;)r.push(".");return r}),cols:i,rows:t}}function Mr(e,t){const i=[];for(let n=0;n<e.length;n++)for(let r=0;r<e[n].length;r++)e[n][r]===t&&i.push([r,n]);return i}function Ud(e,t=0){var i,n,r,s,a,o,c,l;const u=(i=(n=(r=e.layers)===null||r===void 0?void 0:r[t])!==null&&n!==void 0?n:(s=e.layers)===null||s===void 0?void 0:s[0])!==null&&i!==void 0?i:e.map;if(!u)throw new Error("LevelDef needs map or layers");const{grid:f,cols:h,rows:d}=Dd(u);let _=0,M=0;for(let b=0;b<d;b++)for(let z=0;z<h;z++)f[b][z]==="@"&&(_=z,M=b);const m=Mr(f,"s"),p=Mr(f,"S");let T=0,w=0;const y=((a=e.switches)!==null&&a!==void 0?a:[]).map(b=>{const z=b.type==="hard"?p[w++]:m[T++];return z?{...b,col:z[0],row:z[1]}:{...b}}),A=Mr(f,"p"),R=((o=e.splitPads)!==null&&o!==void 0?o:[]).map((b,z)=>{const H=A[z];return H?{...b,col:H[0],row:H[1]}:{...b}}),P=Mr(f,"t"),v=((c=e.teleports)!==null&&c!==void 0?c:[]).map((b,z)=>{const H=P[z];return H?{...b,col:H[0],row:H[1]}:{...b}}),E=new Map,W=new Map;for(const b of(l=e.bridges)!==null&&l!==void 0?l:[]){E.set(b.id,b.cells);for(const[z,H]of b.cells)W.set(`${z},${H}`,b.id)}return{def:e,grid:f,cols:h,rows:d,startCol:_,startRow:M,bridgeCells:E,cellToBridge:W,switches:y,splitPads:R,teleports:v}}function Ss(e,t,i){return t<0||i<0||t>=e.cols||i>=e.rows?".":e.grid[i][t]}function Un(e,t,i,n,r={}){if(r[`${t},${i}`])return".";const s=Ss(e,t,i);if(s==="b"){const a=e.cellToBridge.get(`${t},${i}`);return!a||!n[a]?".":"x"}return s==="s"||s==="S"||s==="p"||s==="u"||s==="t"||s==="c"||s==="@"?"x":s}function co(e,t,i={},n={},r=!1){const s=Vt(t);if(s.length===1){const c=Un(e,s[0].col,s[0].row,i,n);return c==="z"?"hazard":c==="."||!r&&c==="f"?"fall":null}const a=Un(e,s[0].col,s[0].row,i,n),o=Un(e,s[1].col,s[1].row,i,n);return a==="z"||o==="z"?"hazard":a==="."&&o==="."?"fall":null}function Nd(e,t,i={},n={}){return co(e,t,i,n)!==null}function Od(e,t,i={},n={}){const r=Vt(t);return r.length!==2?!1:Un(e,r[0].col,r[0].row,i,n)==="o"&&Un(e,r[1].col,r[1].row,i,n)==="o"}function Fd(e,t,i,n=!1){const r=e.switches;if(!r.length)return i;const s=Vt(t);let a={...i},o=!1;for(const c of r)if(s.some(l=>l.col===c.col&&l.row===c.row)&&!(c.type==="hard"&&(n||t.ori!=="standing")))for(const l of c.bridgeIds)c.mode==="toggle"&&(a[l]=!a[l],o=!0);return o?a:i}function Bd(e,t,i=!1){if(i||t.ori!=="standing"||!e.teleports.length)return null;for(const n of e.teleports){if(t.col!==n.col||t.row!==n.row)continue;const[r,s]=n.dest;return r===t.col&&s===t.row?null:{col:r,row:s,ori:"standing"}}return null}function ys(e,t,i,n){if(!t.length)return n;const r=new Set(i.map(o=>`${o.col},${o.row}`));let s=n,a=!1;for(const o of t){const c=`${o.col},${o.row}`;r.has(c)||n[c]||Ss(e,o.col,o.row)==="c"&&(a||(s={...n},a=!0),s[c]=!0)}return s}function Nn(e){"@babel/helpers - typeof";return Nn=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(t){return typeof t}:function(t){return t&&typeof Symbol=="function"&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},Nn(e)}function zd(e,t){if(Nn(e)!="object"||!e)return e;var i=e[Symbol.toPrimitive];if(i!==void 0){var n=i.call(e,t||"default");if(Nn(n)!="object")return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(e)}function Vd(e){var t=zd(e,"string");return Nn(t)=="symbol"?t:t+""}function ae(e,t,i){return(t=Vd(t))in e?Object.defineProperty(e,t,{value:i,enumerable:!0,configurable:!0,writable:!0}):e[t]=i,e}var Gd=class{constructor(e,t){ae(this,"layer",new gi),ae(this,"startCol",0),ae(this,"startRow",0),ae(this,"offsetX",0),ae(this,"offsetZ",0),ae(this,"def",null),ae(this,"parsed",null),ae(this,"tweens",void 0),ae(this,"geo",new Ni(.96,.25,.96,3,.075)),ae(this,"goalInsetGeo",new Ni(.67,.055,.67,3,.08)),ae(this,"goalDockGeo",new Ni(.82,.08,.82,4,.1)),ae(this,"goalDockMat",new ut({color:12189665,emissive:3594651,emissiveIntensity:.28,metalness:.01,roughness:.38})),ae(this,"goalInsetMat",new ut({color:9565128,emissive:2873491,emissiveIntensity:.48,metalness:.02,roughness:.42})),ae(this,"trayBaseMat",new ut({color:7520228,metalness:.02,roughness:.46})),ae(this,"trayRimMat",new ut({color:14152444,metalness:.01,roughness:.4})),ae(this,"trayInsetMat",new ut({color:4167363,metalness:0,roughness:.64})),ae(this,"trayMeshes",[]),ae(this,"trayTweens",[]),ae(this,"highAltitude",!1),ae(this,"mats",{x:new ut({color:16251903,metalness:0,roughness:.62}),o:new ut({color:3724955,emissive:747591,emissiveIntensity:.2,metalness:0,roughness:.52}),z:new ut({color:14042426,metalness:0,roughness:.78}),f:new ut({color:15246103,metalness:0,roughness:.8}),b:new ut({color:10406376,metalness:0,roughness:.78}),s:new ut({color:15783274,metalness:0,roughness:.75}),S:new ut({color:14252074,metalness:0,roughness:.75}),p:new ut({color:10980288,metalness:0,roughness:.78}),u:new ut({color:5220568,metalness:0,roughness:.78}),t:new ut({color:3066048,emissive:1011562,emissiveIntensity:.28,metalness:.05,roughness:.62}),c:new ut({color:10134445,metalness:0,roughness:.92})}),ae(this,"ringGeo",new wc(.28,.045,8,20)),ae(this,"ringMat",new ut({color:14221307,emissive:6220500,emissiveIntensity:.45,metalness:.1,roughness:.4})),ae(this,"bridgeMeshes",new Map),ae(this,"crumbleMeshes",new Map),this.tweens=t,e.add(this.layer)}load(e,t=0,i={},n={}){this.clearImmediate(),this.bridgeMeshes.clear(),this.crumbleMeshes.clear(),this.def=e,this.parsed=Ud(e,t),this.startCol=this.parsed.startCol,this.startRow=this.parsed.startRow,this.offsetX=-this.parsed.cols/2+.5,this.offsetZ=-this.parsed.rows/2+.5,this.layer.position.set(this.offsetX,0,this.offsetZ),this.addTray(this.parsed.cols,this.parsed.rows);for(let s=0;s<this.parsed.rows;s++)for(let a=0;a<this.parsed.cols;a++){const o=this.parsed.grid[s][a];if(o===".")continue;if(o==="b"){var r;const l=this.createTile(this.mats.b,a,s,"b");l.visible=!!i[(r=this.parsed.cellToBridge.get(`${a},${s}`))!==null&&r!==void 0?r:""],this.bridgeMeshes.set(`${a},${s}`,l);continue}const c=o==="@"?"x":o;if(this.mats[c]){const l=this.createTile(this.mats[c],a,s,c);if(o==="t"&&this.addTeleportRing(l),o==="c"){const u=`${a},${s}`;this.crumbleMeshes.set(u,l),n[u]&&(l.visible=!1,l.scale.set(.05,1,.05))}}}}addTray(e,t){const i=e+1.34,n=Math.max(t+1.34,4.3),r=(e-1)/2,s=(t-1)/2,a=new Ni(i,.58,n,6,.24),o=new Ni(i-.2,.22,n-.2,6,.2),c=new Ni(i-.46,.12,n-.46,5,.18),l=new lt(a,this.trayBaseMat);l.position.set(r,-.59,s),l.castShadow=!0,l.receiveShadow=!0,l.userData.trayGeometry=a,l.userData.trayBaseY=l.position.y,this.layer.add(l);const u=new lt(o,this.trayRimMat);u.position.set(r,-.36,s),u.castShadow=!0,u.receiveShadow=!0,u.userData.trayGeometry=o,u.userData.trayBaseY=u.position.y,this.layer.add(u);const f=new lt(c,this.trayInsetMat);f.position.set(r,-.225,s),f.castShadow=!1,f.receiveShadow=!0,f.userData.trayGeometry=c,f.userData.trayBaseY=f.position.y,this.layer.add(f),this.trayMeshes.push(l,u,f);for(const h of this.trayMeshes)h.visible=!this.highAltitude}setHighAltitude(e){if(!(this.highAltitude===e&&this.trayMeshes.every(t=>t.visible!==e))){this.highAltitude=e;for(const t of this.trayTweens)t.stop();this.trayTweens.length=0;for(const t of this.trayMeshes){const i=t.userData.trayBaseY;e||(t.visible=!0,t.position.y=i-.28,t.scale.set(.96,1,.96));const n={y:t.position.y,scale:t.scale.x},r=new Mt(n,this.tweens).to(e?{y:i-.32,scale:.96}:{y:i,scale:1},wt(e?240:320)).easing(e?dt.Quadratic.In:dt.Cubic.Out).onUpdate(()=>{t.position.y=n.y,t.scale.set(n.scale,1,n.scale)}).onComplete(()=>{t.visible=!e,t.position.y=i,t.scale.set(1,1,1)}).start();this.trayTweens.push(r)}}}setLayer(e,t,i={}){this.def&&this.load(this.def,e,t,i)}syncBridges(e){if(this.parsed)for(const[t,i]of this.bridgeMeshes){const n=this.parsed.cellToBridge.get(t),r=!!(n&&e[n]);if(i.visible===r)continue;i.visible=!0;const s={v:r?.2:1};new Mt(s,this.tweens).to({v:r?1:.05},wt(220)).onUpdate(()=>i.scale.set(s.v,1,s.v)).onComplete(()=>{i.visible=r,r&&i.scale.set(1,1,1)}).start()}}syncCollapsed(e){for(const[t,i]of this.crumbleMeshes){if(!e[t]){i.visible=!0,i.scale.set(1,1,1),i.position.y=-.125;continue}if(!i.visible&&i.scale.x<.1)continue;i.visible=!0;const n={v:1,y:-.125};new Mt(n,this.tweens).to({v:.05,y:-.55},wt(260)).easing(dt.Quadratic.In).onUpdate(()=>{i.scale.set(n.v,1,n.v),i.position.y=n.y}).onComplete(()=>{i.visible=!1}).start()}}createTile(e,t,i,n){const r=new lt(this.geo,e);if(r.position.set(t,-.125,i),r.receiveShadow=!0,r.castShadow=!0,this.layer.add(r),n==="o"){const a=new lt(this.goalDockGeo,this.goalDockMat);a.position.y=.17,a.castShadow=!1,a.receiveShadow=!1,r.add(a);const o=new lt(this.goalInsetGeo,this.goalInsetMat);o.position.y=.23,o.castShadow=!1,o.receiveShadow=!1,r.add(o)}const s={v:.72};return r.scale.set(s.v,1,s.v),new Mt(s,this.tweens).delay((t+i)*16).to({v:1},wt(260)).easing(dt.Cubic.Out).onUpdate(()=>r.scale.set(s.v,1,s.v)).start(),r}addTeleportRing(e){const t=new lt(this.ringGeo,this.ringMat);t.rotation.x=Math.PI/2,t.position.y=.18,t.castShadow=!1,t.receiveShadow=!1,e.add(t)}isDeath(e,t,i={}){return this.parsed?Nd(this.parsed,e,t,i):!0}isWin(e,t,i={}){return this.parsed?Od(this.parsed,e,t,i):!1}toWorld(e,t){return{x:this.offsetX+e,z:this.offsetZ+t}}shake(){const e=[];for(const t of this.layer.children){const i=t;this.trayMeshes.includes(i)||e.push({mesh:i,x:i.position.x,y:i.position.y,z:i.position.z})}for(const t of e)new Mt(t.mesh.position,this.tweens).to({x:t.x+(Math.random()-.5)*.12,y:t.y+(Math.random()-.5)*.12*.6,z:t.z+(Math.random()-.5)*.12},wt(90)).easing(dt.Quadratic.Out).yoyo(!0).repeat(3).onComplete(()=>{t.mesh.position.set(t.x,t.y,t.z),t.mesh.rotation.set(0,0,0)}).start()}remove(e){for(const t of this.layer.children){const i=t;if(this.trayMeshes.includes(i))continue;const n={v:1};new Mt(n,this.tweens).to({v:0},wt(280)).easing(dt.Quadratic.InOut).onUpdate(()=>i.scale.setScalar(n.v)).start()}new Mt({t:0},this.tweens).to({t:1},wt(420)).onComplete(()=>{this.clearImmediate(),e()}).start()}clearImmediate(){for(const e of this.trayTweens)e.stop();for(this.trayTweens.length=0;this.layer.children.length;){const e=this.layer.children[0],t=e.userData.trayGeometry;t==null||t.dispose(),this.layer.remove(e)}this.trayMeshes.length=0}};function kd(e,t,i,n,r,s){const a=Math.min(s,n/2,r/2);e.beginPath(),e.moveTo(t+a,i),e.arcTo(t+n,i,t+n,i+r,a),e.arcTo(t+n,i+r,t,i+r,a),e.arcTo(t,i+r,t,i,a),e.arcTo(t,i,t+n,i,a),e.closePath()}function Sr(e){const t=document.createElement("canvas");t.width=256,t.height=128;const i=t.getContext("2d");if(!i)return new jn({transparent:!0});const n="#123b58",r="#f8fdff";if(i.lineCap="round",i.lineJoin="round",e==="happy")i.strokeStyle=r,i.lineWidth=18,i.beginPath(),i.arc(83,62,24,Math.PI*.12,Math.PI*.88),i.stroke(),i.beginPath(),i.arc(173,62,24,Math.PI*.12,Math.PI*.88),i.stroke(),i.strokeStyle=n,i.lineWidth=9,i.beginPath(),i.arc(128,81,25,Math.PI*.12,Math.PI*.88),i.stroke();else{for(const a of[78,178])kd(i,a-31,28,62,e==="surprised"?68:58,27),i.fillStyle=r,i.fill(),i.beginPath(),i.arc(a+(e==="focus"?6:0),58,e==="surprised"?13:15,0,Math.PI*2),i.fillStyle=n,i.fill(),i.beginPath(),i.arc(a+5,52,4.5,0,Math.PI*2),i.fillStyle=r,i.fill();i.strokeStyle=n,i.lineWidth=8,e==="focus"&&(i.beginPath(),i.moveTo(51,27),i.quadraticCurveTo(77,19,101,29),i.moveTo(155,29),i.quadraticCurveTo(179,19,205,27),i.stroke()),i.beginPath(),e==="surprised"?i.arc(128,96,10,0,Math.PI*2):i.arc(128,78,18,Math.PI*.16,Math.PI*.84),i.stroke()}const s=new Tc(t);return s.colorSpace=It,s.needsUpdate=!0,new jn({map:s,transparent:!0,alphaTest:.08,depthWrite:!1,toneMapped:!1})}var Hd=class{constructor(e,t,i){ae(this,"pivot",new gi),ae(this,"mesh",void 0),ae(this,"pivotB",new gi),ae(this,"meshB",void 0),ae(this,"state",{col:0,row:0,ori:"standing"}),ae(this,"stateB",null),ae(this,"active",0),ae(this,"canMove",!0),ae(this,"tweens",void 0),ae(this,"level",void 0),ae(this,"activeTween",null),ae(this,"matA",new ut({color:1486791,emissive:407882,emissiveIntensity:.07,metalness:.04,roughness:.5})),ae(this,"matB",new ut({color:7522519,emissive:802121,emissiveIntensity:.05,metalness:.03,roughness:.56})),ae(this,"matActive",new ut({color:886948,emissive:474707,emissiveIntensity:.11,metalness:.04,roughness:.46})),ae(this,"faceMaterials",{idle:Sr("idle"),focus:Sr("focus"),surprised:Sr("surprised"),happy:Sr("happy")}),ae(this,"faceA",void 0),ae(this,"faceB",void 0),this.level=t,this.tweens=i;const n=new Ni(1.12,1.12,1.12,4,.14),r=new cr(.94,.48);this.mesh=new lt(n,this.matA),this.mesh.castShadow=!0,this.pivot.add(this.mesh),this.faceA=new lt(r,this.faceMaterials.idle),this.faceA.renderOrder=3,this.pivot.add(this.faceA),e.add(this.pivot),this.meshB=new lt(n,this.matB),this.meshB.castShadow=!0,this.pivotB.add(this.meshB),this.faceB=new lt(r,this.faceMaterials.idle),this.faceB.renderOrder=3,this.pivotB.add(this.faceB),this.pivotB.visible=!1,e.add(this.pivotB)}get isSplit(){return this.stateB!==null}sizeOf(e,t){return t?{sx:1,sy:1,sz:1}:lo(e)}centerOf(e,t){return t?{x:e.col,y:.5,z:e.row}:Ld(e)}placeEntity(e,t,i,n=1){const r=this.centerOf(t,i),s=this.sizeOf(t,i),{x:a,z:o}=this.level.toWorld(r.x,r.z),c=e==="a"?this.pivot:this.pivotB,l=e==="a"?this.mesh:this.meshB;c.visible=!0,c.rotation.set(0,0,0),l.position.set(0,0,0),l.rotation.set(0,0,0),l.scale.set(s.sx*n,s.sy*n,s.sz*n),this.positionFace(e,s,l.position),(e==="a"?this.faceA:this.faceB).scale.setScalar(n),c.position.set(a,r.y,o)}positionFace(e,t,i){const n=e==="a"?this.faceA:this.faceB,r=t.sy>1.4?.27:.1;n.position.set(i.x,i.y+r,i.z+t.sz*.56+.025),n.rotation.set(0,0,0)}setMood(e){this.faceA.material=this.faceMaterials[e],this.faceB.material=this.faceMaterials[e]}placeMerged(e,t=1){this.state=it(e),this.stateB=null,this.active=0,this.pivotB.visible=!1,this.placeEntity("a",e,!1,t),this.refreshMaterials()}placeSplit(e,t,i=0){this.state=it(e),this.stateB=it(t),this.active=i,this.placeEntity("a",e,!0),this.placeEntity("b",t,!0),this.refreshMaterials()}animateSplit(e,t,i){this.canMove=!1,this.stopTween();const n=it(this.state),[r,s]=this.splitStartCenters(n,e,t);this.state=it(e),this.stateB=it(t),this.active=0;const a=this.level.toWorld(r.x,r.z),o=this.level.toWorld(s.x,s.z),c=this.level.toWorld(e.col,e.row),l=this.level.toWorld(t.col,t.row);this.pivot.visible=!0,this.pivotB.visible=!0,this.pivot.rotation.set(0,0,0),this.pivotB.rotation.set(0,0,0),this.mesh.position.set(0,0,0),this.meshB.position.set(0,0,0),this.mesh.rotation.set(0,0,0),this.meshB.rotation.set(0,0,0),this.mesh.scale.set(1,1,1),this.meshB.scale.set(1,1,1),this.positionFace("a",{sx:1,sy:1,sz:1},this.mesh.position),this.positionFace("b",{sx:1,sy:1,sz:1},this.meshB.position),this.faceA.scale.setScalar(1),this.faceB.scale.setScalar(1),this.pivot.position.set(a.x,r.y,a.z),this.pivotB.position.set(o.x,s.y,o.z),this.refreshMaterials();const u=Math.max(Math.hypot(c.x-a.x,c.z-a.z),Math.hypot(l.x-o.x,l.z-o.z)),f=wt(Math.min(460,280+u*50)),h={u:0};this.activeTween=new Mt(h,this.tweens).to({u:1},f).easing(dt.Cubic.Out).onUpdate(()=>{const d=h.u,_=Math.sin(Math.PI*d)*.28;this.pivot.position.set(a.x+(c.x-a.x)*d,r.y+(.5-r.y)*d+_,a.z+(c.z-a.z)*d),this.pivotB.position.set(o.x+(l.x-o.x)*d,s.y+(.5-s.y)*d+_,o.z+(l.z-o.z)*d)}).onComplete(()=>{this.activeTween=null,this.placeEntity("a",e,!0),this.placeEntity("b",t,!0),this.canMove=!0,i()}).start()}animateTeleport(e,t){this.canMove=!1,this.stopTween();const i=it(this.state);this.state=it(e),this.stateB=null,this.active=0,this.pivotB.visible=!1;const n=this.centerOf(i,!1),r=this.centerOf(e,!1),s=this.level.toWorld(n.x,n.z),a=this.level.toWorld(r.x,r.z),o=this.sizeOf(i,!1);this.placeEntity("a",i,!1),this.refreshMaterials();const c={u:0},l=wt(420);this.activeTween=new Mt(c,this.tweens).to({u:1},l).easing(dt.Cubic.InOut).onUpdate(()=>{const u=c.u,f=u<.45?1-u/.45*.88:(u-.45)/.55*.88+.12,h=u<.45?0:(u-.45)/.55,d=s.x+(a.x-s.x)*h,_=s.z+(a.z-s.z)*h,M=n.y+(r.y-n.y)*h+Math.sin(Math.PI*h)*.55;this.mesh.scale.set(o.sx*f,o.sy*f,o.sz*f),this.faceA.scale.setScalar(f),this.pivot.position.set(d,M,_)}).onComplete(()=>{this.activeTween=null,this.placeEntity("a",e,!1),this.canMove=!0,t()}).start()}splitStartCenters(e,t,i){const n=e.ori==="standing"?[{x:e.col,y:.5,z:e.row},{x:e.col,y:1.5,z:e.row}]:e.ori==="flatX"?[{x:e.col,y:.5,z:e.row},{x:e.col+1,y:.5,z:e.row}]:[{x:e.col,y:.5,z:e.row},{x:e.col,y:.5,z:e.row+1}],r=(a,o)=>(a.x-o.col)**2+(a.z-o.row)**2,s=r(n[0],t)+r(n[1],i);return r(n[0],i)+r(n[1],t)<s?[n[1],n[0]]:[n[0],n[1]]}refreshMaterials(){if(!this.isSplit){this.mesh.material=this.matA;return}this.mesh.material=this.active===0?this.matActive:this.matA,this.meshB.material=this.active===1?this.matActive:this.matB}toggleActive(){this.isSplit&&(this.active=this.active===0?1:0,this.refreshMaterials())}reset(e,t){this.stopTween(),this.canMove=!1,this.placeMerged(e,1),this.setMood("idle");const i=lo(e),n={v:.75};this.mesh.scale.set(i.sx*n.v,i.sy*n.v,i.sz*n.v),this.faceA.scale.setScalar(n.v),new Mt(n,this.tweens).to({v:1},wt(250)).easing(dt.Quadratic.Out).onUpdate(()=>{this.mesh.scale.set(i.sx*n.v,i.sy*n.v,i.sz*n.v),this.faceA.scale.setScalar(n.v)}).onComplete(()=>{this.canMove=!0,t==null||t()}).start()}tryMove(e,t,i){if(!this.canMove)return!1;const n=this.isSplit,r=!n||this.active===0?"a":"b",s=r==="a"?this.state:this.stateB,a=n?Cd(s,e):Rd(s,e),o=this.planFlip(s,a,e,r,n);return this.canMove=!1,this.setMood("focus"),this.animateFlip(o,()=>{r==="a"?this.state=it(a):this.stateB=it(a),this.placeEntity(r,a,n),this.setMood("idle"),this.canMove=!0,t()},i),!0}planFlip(e,t,i,n,r){const s=this.centerOf(e,r);let a={x:s.x,y:0,z:s.z},o="z",c=0;const l=.5;i==="left"?(o="z",c=Math.PI/2,r||e.ori==="standing"?a={x:s.x-l,y:0,z:s.z}:e.ori==="flatX"?a={x:s.x-1,y:0,z:s.z}:a={x:s.x-l,y:0,z:s.z}):i==="right"?(o="z",c=-Math.PI/2,r||e.ori==="standing"?a={x:s.x+l,y:0,z:s.z}:e.ori==="flatX"?a={x:s.x+1,y:0,z:s.z}:a={x:s.x+l,y:0,z:s.z}):i==="up"?(o="x",c=-Math.PI/2,r||e.ori==="standing"?a={x:s.x,y:0,z:s.z-l}:e.ori==="flatZ"?a={x:s.x,y:0,z:s.z-1}:a={x:s.x,y:0,z:s.z-l}):(o="x",c=Math.PI/2,r||e.ori==="standing"?a={x:s.x,y:0,z:s.z+l}:e.ori==="flatZ"?a={x:s.x,y:0,z:s.z+1}:a={x:s.x,y:0,z:s.z+l});const u=this.level.toWorld(a.x,a.z);return{pivotWorld:{x:u.x,y:0,z:u.z},axis:o,angle:c,next:t,target:n,asCube:r}}animateFlip(e,t,i){const n=e.target==="a"?this.state:this.stateB,r=this.sizeOf(n,e.asCube),s=this.centerOf(n,e.asCube),a=this.level.toWorld(s.x,s.z),o=e.target==="a"?this.pivot:this.pivotB,c=e.target==="a"?this.mesh:this.meshB;o.position.set(e.pivotWorld.x,e.pivotWorld.y,e.pivotWorld.z),o.rotation.set(0,0,0),c.position.set(a.x-e.pivotWorld.x,s.y-e.pivotWorld.y,a.z-e.pivotWorld.z),c.scale.set(r.sx,r.sy,r.sz),this.positionFace(e.target,r,c.position);const l={x:0,y:0,z:0},u=e.axis==="z"?{z:e.angle}:{x:e.angle};this.activeTween=new Mt(l,this.tweens).to(u,wt(230)).easing(dt.Cubic.In).onUpdate(()=>{o.rotation.set(l.x,l.y,l.z)}).onComplete(()=>{this.activeTween=null,i==null||i(),t()}).start()}fall(e){this.canMove=!1,this.stopTween();const t={v:1,y:0},i=[this.mesh,...this.pivotB.visible?[this.meshB]:[]],n=[this.pivot,...this.pivotB.visible?[this.pivotB]:[]],r=[this.faceA,...this.pivotB.visible?[this.faceB]:[]],s=i.map(o=>({x:o.scale.x,y:o.scale.y,z:o.scale.z})),a=n.map(o=>o.position.y);new Mt(t,this.tweens).to({v:0,y:-1.2},wt(340)).easing(dt.Quadratic.In).onUpdate(()=>{i.forEach((o,c)=>o.scale.set(s[c].x*t.v,s[c].y*t.v,s[c].z*t.v)),r.forEach(o=>o.scale.setScalar(t.v)),n.forEach((o,c)=>{o.position.y=a[c]+t.y})}).onComplete(e).start()}fallHighAltitude(e,t,i,n){this.canMove=!1,this.stopTween();const r=Ms(),s=r?280:1e3,a=new Set(e),o=[...new Set([...e,...t])].map(h=>{const d=h==="a"?this.pivot:this.pivotB,_=h==="a"?this.mesh:this.meshB,M=h==="a"?this.faceA:this.faceB,m=_.material,p=M.material,T=m.clone(),w=p.clone();return T.transparent=!0,T.depthWrite=!1,T.opacity=1,T.needsUpdate=!0,w.transparent=!0,w.depthWrite=!1,w.opacity=1,w.needsUpdate=!0,_.material=T,M.material=w,{kind:a.has(h)?"fall":"hazard",pivot:d,mesh:_,face:M,bodyMaterial:m,faceMaterial:p,fadeBodyMaterial:T,fadeFaceMaterial:w,pivotPosition:d.position.clone(),pivotRotation:d.rotation.clone(),meshScale:_.scale.clone(),faceScale:M.scale.clone(),pivotVisible:d.visible}}),c=i==="left"?{x:-1,z:0,sign:1,axis:"z"}:i==="right"?{x:1,z:0,sign:-1,axis:"z"}:i==="up"?{x:0,z:-1,sign:-1,axis:"x"}:{x:0,z:1,sign:1,axis:"x"};let l=!1;const u=h=>{if(!l){l=!0;for(const d of o){if(d.mesh.material=d.bodyMaterial,d.face.material=d.faceMaterial,d.fadeBodyMaterial.dispose(),d.fadeFaceMaterial.dispose(),h){d.pivot.visible=!1;continue}d.pivot.visible=d.pivotVisible,d.pivot.position.copy(d.pivotPosition),d.pivot.rotation.copy(d.pivotRotation),d.mesh.scale.copy(d.meshScale),d.face.scale.copy(d.faceScale)}}},f={t:0};this.activeTween=new Mt(f,this.tweens).to({t:1},s).onUpdate(()=>{const h=f.t*s/1e3;for(const d of o){if(d.kind==="hazard"){const w=Math.min(1,h/.34),y=w*w;d.pivot.position.y=d.pivotPosition.y-1.2*y,d.mesh.scale.copy(d.meshScale).multiplyScalar(1-w),d.face.scale.copy(d.faceScale).multiplyScalar(1-w),d.fadeBodyMaterial.opacity=1-w,d.fadeFaceMaterial.opacity=1-w;continue}if(r){const w=f.t*f.t;d.pivot.position.y=d.pivotPosition.y-.55*w,d.fadeBodyMaterial.opacity=1-f.t,d.fadeFaceMaterial.opacity=1-f.t;continue}const _=7*h*h,M=5.4/(5.4+_),m=h*Math.PI*2*1.4*c.sign,p=ea.clamp((f.t-.64)/.17999999999999994,0,1),T=1-p*p*(3-2*p);d.pivot.position.set(d.pivotPosition.x+c.x*.9*h,d.pivotPosition.y-_,d.pivotPosition.z+c.z*.9*h),d.pivot.rotation.set(d.pivotRotation.x+(c.axis==="x"?m:m*.16),d.pivotRotation.y+m*.14,d.pivotRotation.z+(c.axis==="z"?m:m*.16)),d.mesh.scale.copy(d.meshScale).multiplyScalar(M),d.face.scale.copy(d.faceScale).multiplyScalar(M),d.fadeBodyMaterial.opacity=T,d.fadeFaceMaterial.opacity=T}}).onStop(()=>u(!1)).onComplete(()=>{this.activeTween=null,u(!0),n()}).start()}win(e){this.canMove=!1,this.stopTween();const t=this.pivot.position.y,i={y:t,spin:0},n=this.mesh.scale.x,r=this.mesh.scale.y,s=this.mesh.scale.z;this.setMood("happy");const a=new Mt(i,this.tweens).to({y:t+.85,spin:Math.PI*2},wt(520)).easing(dt.Cubic.Out).onUpdate(()=>{this.pivot.position.y=i.y,this.pivot.rotation.y=i.spin}),o={v:1},c=new Mt(o,this.tweens).to({v:0},wt(300)).easing(dt.Quadratic.In).onUpdate(()=>{this.mesh.scale.set(n*o.v,r*o.v,s*o.v),this.faceA.scale.setScalar(o.v)}).onComplete(e);a.chain(c).start()}stopTween(){this.activeTween&&(this.activeTween.stop(),this.activeTween=null)}},yr=[{map:["@xxxxxxoo"],chapter:"基础"},{map:["@xxxxxx","......x","......x","......x","...o..x","...o..x","...xxxx"],chapter:"基础"},{map:["@xxxxxx.x","........x","........x",".ooxx.xxx","........."],chapter:"基础"},{map:["......xx..","..........","@xxxxxxxoo"],chapter:"基础"},{map:[".........xx","@xooxxxxxxx"],chapter:"基础"},{map:["@xoo",".xxx"],chapter:"基础"},{map:["..o","@xo","x.x"],chapter:"基础"},{map:["zz....","xx....","x@.xoo"],chapter:"基础",hint:"别让砖块落到红色区域。"},{map:["....xx.","....xx.","....xx.","....x..",".......","@xxxxxx",".....oo"],chapter:"基础"},{map:["@.x....",".x.x...","....x.x",".o.x.x.",".ox.x.x"],chapter:"基础"},{map:["xxxxxx","xxx..x","x....x","x.oo.x","x..x.x","x..x.x","@..xxx"],chapter:"基础"},{map:["@.x.xxx.x.x","xxx.x.x.x.x",".x..xxx.xxx","...........","x.x..x..xxx","xxx..x..x.o","xxx..x..x.o"],chapter:"基础"},{map:["@xxxx","x.z.x","x.z.x","x...x","x.oox","xxxxx"],chapter:"基础"},{map:["@xxxxx","x...x.","x.x.x.","x.x.oo","x.xxx."],chapter:"基础"},{map:["..x..x..","@xxxxxx.","..x..x.x",".....x.x",".z...x.x",".z.oox.x","...xxxx."],chapter:"基础"},{map:["@xx","xff",".oo"],chapter:"脆弱",hint:"橙色砖只能横躺通过；竖着站上去会碎。"},{map:["@x.x","xff.","..oo"],chapter:"脆弱"},{map:["@xff","x..x",".xoo"],chapter:"脆弱"},{map:["@xxx","xffx","..oo"],chapter:"脆弱"},{map:["@xxf","xf.x","x..x","..oo"],chapter:"脆弱"},{map:["@fxx","xff.x","x..x",".xoo"],chapter:"脆弱"},{map:["@xxf","xff.x","x..x","..oo"],chapter:"脆弱"},{map:["@xfxx","xff.x","x..x","..oo"],chapter:"脆弱"},{map:["@sbboo"],chapter:"桥梁",hint:"踩上黄色按钮，会开关隐藏的蓝桥。",bridges:[{id:"A",cells:[[2,0],[3,0]],initiallyOpen:!1}],switches:[{col:1,row:0,type:"soft",bridgeIds:["A"],mode:"toggle"}]},{map:["@xxs","xbb.","..oo"],chapter:"桥梁",bridges:[{id:"A",cells:[[1,1],[2,1]],initiallyOpen:!1}],switches:[{col:3,row:0,type:"soft",bridgeIds:["A"],mode:"toggle"}]},{map:["@xxs","bb..","xxoo"],chapter:"桥梁",bridges:[{id:"A",cells:[[0,1],[1,1]],initiallyOpen:!1}],switches:[{col:3,row:0,type:"soft",bridgeIds:["A"],mode:"toggle"}]},{map:["@x.s","bb.x","x.oo"],chapter:"桥梁",bridges:[{id:"A",cells:[[0,1],[1,1]],initiallyOpen:!1}],switches:[{col:3,row:0,type:"soft",bridgeIds:["A"],mode:"toggle"}]},{map:["@x.s","xbb.","x.oo"],chapter:"桥梁",bridges:[{id:"A",cells:[[1,1],[2,1]],initiallyOpen:!1}],switches:[{col:3,row:0,type:"soft",bridgeIds:["A"],mode:"toggle"}]},{map:["@xxs",".bb.","x.oo"],chapter:"桥梁",bridges:[{id:"A",cells:[[1,1],[2,1]],initiallyOpen:!1}],switches:[{col:3,row:0,type:"soft",bridgeIds:["A"],mode:"toggle"}]},{map:["@xs.","xbb.","..oo"],chapter:"桥梁",bridges:[{id:"A",cells:[[1,1],[2,1]],initiallyOpen:!1}],switches:[{col:2,row:0,type:"soft",bridgeIds:["A"],mode:"toggle"}]},{map:["@s..","xbbx","x.oo"],chapter:"桥梁",bridges:[{id:"A",cells:[[1,1],[2,1]],initiallyOpen:!1}],switches:[{col:1,row:0,type:"soft",bridgeIds:["A"],mode:"toggle"}]},{map:["@..x","xxSx","bb.x","..oo"],chapter:"桥梁",hint:"橙色按钮要竖着踩上去，才会开关蓝桥。",bridges:[{id:"A",cells:[[0,2],[1,2]],initiallyOpen:!1}],switches:[{col:2,row:1,type:"hard",bridgeIds:["A"],mode:"toggle"}]},{map:["@xxx","..Sx","bb.x","..oo"],chapter:"桥梁",bridges:[{id:"A",cells:[[0,2],[1,2]],initiallyOpen:!1}],switches:[{col:2,row:1,type:"hard",bridgeIds:["A"],mode:"toggle"}]},{map:["@x.x","xS..","bb.x","..oo"],chapter:"桥梁",bridges:[{id:"A",cells:[[0,2],[1,2]],initiallyOpen:!1}],switches:[{col:1,row:1,type:"hard",bridgeIds:["A"],mode:"toggle"}]},{map:["@xxS","....","bb.x","..oo"],chapter:"桥梁",bridges:[{id:"A",cells:[[0,2],[1,2]],initiallyOpen:!1}],switches:[{col:3,row:0,type:"hard",bridgeIds:["A"],mode:"toggle"}]},{map:["@x.x","x.Sx","bb.x","x.oo"],chapter:"桥梁",bridges:[{id:"A",cells:[[0,2],[1,2]],initiallyOpen:!1}],switches:[{col:2,row:1,type:"hard",bridgeIds:["A"],mode:"toggle"}]},{map:["@sbb.","xxSbb","...oo"],chapter:"桥梁",bridges:[{id:"A",cells:[[2,0],[3,0]],initiallyOpen:!1},{id:"B",cells:[[3,1],[4,1]],initiallyOpen:!1}],switches:[{col:1,row:0,type:"soft",bridgeIds:["A"],mode:"toggle"},{col:2,row:1,type:"hard",bridgeIds:["B"],mode:"toggle"}]},{map:["@pxxx","x...x","xx.oo"],chapter:"分裂",hint:"碰到紫砖会分成两块。按“切换”换一块控制；两块相遇会合成一块。",splitPads:[{col:1,row:0,destA:[0,1],destB:[4,1]}]},{map:["@xpxx","x...x","xx.oo"],chapter:"分裂",splitPads:[{col:2,row:0,destA:[0,1],destB:[4,1]}]},{map:["@xxpx","x...x","xx.oo"],chapter:"分裂",splitPads:[{col:3,row:0,destA:[0,1],destB:[4,1]}]},{map:["@p.xx","x..x.","x..x.","x.oo."],chapter:"分裂",splitPads:[{col:1,row:0,destA:[0,2],destB:[3,2]}]},{map:["@x.px","x..x.","x..xx","..oo."],chapter:"分裂",splitPads:[{col:3,row:0,destA:[0,1],destB:[3,1]}]},{map:["@xxxp","x...x","x.z.x","xx.oo"],chapter:"分裂",splitPads:[{col:4,row:0,destA:[0,1],destB:[4,1]}]},{map:["@pxxx","x.z.x","x...x","xx.oo"],chapter:"分裂",splitPads:[{col:1,row:0,destA:[0,2],destB:[4,2]}]},{map:["@xpx.","x..x.","x..x.","x.oo."],chapter:"分裂",splitPads:[{col:2,row:0,destA:[0,1],destB:[3,2]}]},{map:["@x.px","xxxxx","x...x","xx.oo"],chapter:"分裂",splitPads:[{col:3,row:0,destA:[0,2],destB:[4,2]}]},{map:["@x.px","x.z.x","xxxxx","xx.oo"],chapter:"分裂",splitPads:[{col:3,row:0,destA:[0,2],destB:[4,2]}]},{map:["@xp.x","x.z.x","x...x","xx.oo"],chapter:"分裂",splitPads:[{col:2,row:0,destA:[0,1],destB:[4,1]}]},{layers:[["@xu","xxx"],[".xu","oo."]],chapter:"多层",hint:"竖着踩蓝色砖，会切换到另一层。"},{layers:[["@xux","xxxx"],[".xux","oo.."]],chapter:"多层"},{layers:[["@xuxx","xxxxx"],[".xuxx","oo..."]],chapter:"多层"},{layers:[["@xu.x","xxxx."],[".xu.x","oo.x."]],chapter:"多层"},{layers:[["@xux.","x.x.x","xxxxx"],[".xux.","x...x","oo..."]],chapter:"多层"},{layers:[["@xux.","x.x.x","zxxxx"],[".xux.","x...x","oo..."]],chapter:"多层"},{layers:[["@xux.","xf.xx","xxxxx"],[".xux.","x...x","oo..."]],chapter:"多层"},{map:["@xxt..xoo"],chapter:"传送",hint:"竖着踩上青色砖，整块砖会出现在另一边。",teleports:[{dest:[6,0]}]},{map:["@xx...","x.x...","xxt..xoo"],chapter:"传送",teleports:[{dest:[5,2]}]},{map:["@xx...","xxx...","xxt..xoo"],chapter:"传送",teleports:[{dest:[5,2]}]},{map:["@xx...",".xx...","xxt..xoo"],chapter:"传送",teleports:[{dest:[5,2]}]},{map:["@x.x..","xxx...","xxt..xoo"],chapter:"传送",teleports:[{dest:[5,2]}]},{map:["@xxx..","x.x...","xxt..xoo"],chapter:"传送",teleports:[{dest:[5,2]}]},{map:["@xxt..xxxt..xoo"],chapter:"传送",teleports:[{dest:[6,0]},{dest:[12,0]}]},{map:["@x....","x.xx..","x.t..xoo"],chapter:"传送",teleports:[{dest:[5,2]}]},{map:["@xxx..","x.....","xxt..xoo"],chapter:"传送",teleports:[{dest:[5,2]}]},{map:["@xx...","x..x..","xxt..xoo"],chapter:"传送",teleports:[{dest:[5,2]}]},{map:["@xxz..","x.x...","xxt..xoo"],chapter:"传送",teleports:[{dest:[5,2]}]},{map:["@xx...","x.t..xoo","x...z..."],chapter:"传送",teleports:[{dest:[5,1]}]},{map:["@xx...","x.f...","xxt..xoo"],chapter:"传送",teleports:[{dest:[5,2]}]},{map:["@cc","..x",".oo"],chapter:"崩塌",hint:"灰色裂砖离开后会塌掉，别把自己堵死。"},{map:["@cc.",".xx.",".oo."],chapter:"崩塌"},{map:["@xcc",".xxx",".xoo"],chapter:"崩塌"},{map:["@cccx",".xxx.",".xoo."],chapter:"崩塌"},{map:["@xccc",".xxxx",".xxoo"],chapter:"崩塌"},{map:["@cc.c","xx.xx",".xoo."],chapter:"崩塌"},{map:["@cccc","x.xxx","..xoo"],chapter:"崩塌"},{map:["@xccx","cxxxx","..xoo"],chapter:"崩塌"},{map:["@ccc.",".x.x.",".xoo."],chapter:"崩塌"},{map:["@xccc",".xxxz",".xxoo"],chapter:"崩塌"}],Kt=yr.length;function Es(e){return yr[e]}function ho(e){var t;const i={};for(const n of(t=e.bridges)!==null&&t!==void 0?t:[])i[n.id]=n.initiallyOpen;return i}function uo(){return{}}function fo(e,t,i){return{block:{col:t,row:i,ori:"standing"},blockB:null,active:0,bridges:ho(e),collapsed:uo(),layer:0}}var Wd=class{constructor(){ae(this,"handler",null),ae(this,"enabled",!0),ae(this,"onKey",e=>{if(!this.enabled)return;const t={ArrowLeft:"left",ArrowRight:"right",ArrowUp:"up",ArrowDown:"down",a:"left",A:"left",d:"right",D:"right",w:"up",W:"up",s:"down",S:"down"}[e.key];t&&(e.preventDefault(),this.emit(t))}),window.addEventListener("keydown",this.onKey);for(const e of["pad-up","pad-down","pad-left","pad-right"]){const t=document.getElementById(e);t==null||t.addEventListener("pointerdown",i=>{i.preventDefault();const n=t.dataset.dir;this.emit(n)})}}onMove(e){this.handler=e}setEnabled(e){this.enabled=e}emit(e){!this.enabled||!this.handler||this.handler(e)}},Xd=class{constructor(){ae(this,"ctx",null),ae(this,"muted",!1)}ensure(){if(this.muted)return null;if(!this.ctx){const e=window.AudioContext||window.webkitAudioContext;this.ctx=new e}return this.ctx.state==="suspended"&&this.ctx.resume(),this.ctx}unlock(){this.ensure()}setMuted(e){this.muted=e}beep(e,t,i=.25,n="sine"){const r=this.ensure();if(!r)return;const s=r.createOscillator(),a=r.createGain();s.type=n,s.frequency.value=e,a.gain.value=i,s.connect(a),a.connect(r.destination);const o=r.currentTime;a.gain.setValueAtTime(i,o),a.gain.exponentialRampToValueAtTime(.001,o+t/1e3),s.start(o),s.stop(o+t/1e3)}move(){this.beep(190+Math.random()*25,45,.16,"triangle")}land(){this.beep(120,35,.14,"sine")}fail(){this.beep(140,80,.22,"sawtooth"),setTimeout(()=>this.beep(90,200,.2,"sine"),70)}fallWind(e=900){const t=this.ensure();if(!t)return;const i=Math.max(.2,e/1e3),n=t.createBuffer(1,Math.ceil(t.sampleRate*i),t.sampleRate),r=n.getChannelData(0);for(let l=0;l<r.length;l++)r[l]=Math.random()*2-1;const s=t.createBufferSource(),a=t.createBiquadFilter(),o=t.createGain();s.buffer=n,a.type="bandpass",a.frequency.value=620,a.Q.value=.72,s.connect(a),a.connect(o),o.connect(t.destination);const c=t.currentTime;o.gain.setValueAtTime(.001,c),o.gain.exponentialRampToValueAtTime(.042,c+i*.58),o.gain.exponentialRampToValueAtTime(.001,c+i),a.frequency.setValueAtTime(430,c),a.frequency.exponentialRampToValueAtTime(860,c+i*.82),s.start(c),s.stop(c+i)}win(){[262,330,392,523,659].forEach((e,t)=>{setTimeout(()=>this.beep(e,140,.18,"triangle"),t*85)})}clearLevel(){this.beep(440,60,.14,"sine"),setTimeout(()=>this.beep(554,90,.16,"sine"),70)}},qd=[5,11,12,8,14,7,6,10,19,14,19,14,12,6,13,3,6,6,6,7,4,7,7,3,10,10,9,10,11,8,10,14,16,11,12,17,10,7,7,8,10,9,10,10,8,8,6,9,6,6,6,6,7,8,7,3,9,9,9,9,9,5,9,9,9,9,8,9,3,3,9,9,8,6,8,7,9,8];function Yd(e){var t;return(t=qd[e-1])!==null&&t!==void 0?t:Number.POSITIVE_INFINITY}var po=Kt*3;function Kd(e,t){const i=Yd(t);return e<=i?3:e<=i+3?2:1}function mo(e){return e.reduce((t,i)=>t+(Number(i)||0),0)}function Er(){return Array.from({length:Kt},()=>0)}var go="fan-zhuan-kuai-progress-v3",Zd=["fan-zhuan-kuai-progress-v2","fan-zhuan-kuai-progress-v1"],vo={maxCleared:0,lastPlayed:1,muted:!1,stars:Er()};function $d(e,t){const i=Er();if(Array.isArray(e)){for(let n=0;n<Kt;n++){const r=Math.floor(Number(e[n])||0);i[n]=Math.min(3,Math.max(0,r))}return i}for(let n=0;n<t;n++)i[n]=1;return i}function Jd(){try{let e=localStorage.getItem(go);for(const n of Zd){if(e)break;e=localStorage.getItem(n)}if(!e)return{...vo,stars:Er()};const t=JSON.parse(e),i=Number(t.maxCleared)||0;return{maxCleared:i,lastPlayed:Number(t.lastPlayed)||1,muted:!!t.muted,stars:$d(t.stars,i)}}catch{return{...vo,stars:Er()}}}function bs(e){try{localStorage.setItem(go,JSON.stringify(e))}catch{}}function Qd(e,t,i){var n;const r={...e,stars:e.stars.slice()},s=t-1;return s<0||s>=Kt||(r.stars[s]=Math.max((n=r.stars[s])!==null&&n!==void 0?n:0,i)),r}function jd(e,t){return e<=t||e===t+1}function ef(e,t){return!jd(e,t)}var _o="http://www.w3.org/2000/svg",tf={"icon-lock":'<rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V8a4 4 0 0 1 8 0v3"/>',"icon-grid":'<rect x="3" y="3" width="7" height="7" rx="1.5"/><rect x="14" y="3" width="7" height="7" rx="1.5"/><rect x="3" y="14" width="7" height="7" rx="1.5"/><rect x="14" y="14" width="7" height="7" rx="1.5"/>',"icon-undo":'<path d="M9 14 4 9l5-5"/><path d="M4 9h10.5a5.5 5.5 0 1 1 0 11H12"/>',"icon-restart":'<path d="M21 12a9 9 0 1 1-2.6-6.4"/><path d="M21 3v6h-6"/>',"icon-swap":'<path d="M16 3h5v5"/><path d="M8 21H3v-5"/><path d="M21 3 14 10"/><path d="m3 21 7-7"/><rect x="8.5" y="8.5" width="3" height="3" rx="0.5"/><rect x="12.5" y="12.5" width="3" height="3" rx="0.5"/>',"icon-sound":'<path d="M11 5 6 9H3v6h3l5 4V5z"/><path d="M15.5 8.5a5 5 0 0 1 0 7"/><path d="M18.5 5.5a9 9 0 0 1 0 13"/>',"icon-mute":'<path d="M11 5 6 9H3v6h3l5 4V5z"/><path d="m22 9-6 6"/><path d="m16 9 6 6"/>',"icon-star":'<path d="M12 3.2 14.4 9l6.1.5-4.7 3.9 1.5 5.9L12 15.8 6.7 19.3l1.5-5.9L3.5 9.5 9.6 9z"/>',"icon-check":'<path d="M5 13.5 9.5 18 19 7"/>',"icon-arrow-up":'<path d="m6 14 6-6 6 6"/>',"icon-arrow-down":'<path d="m6 10 6 6 6-6"/>',"icon-arrow-left":'<path d="m14 6-6 6 6 6"/>',"icon-arrow-right":'<path d="m10 6 6 6-6 6"/>'};function hn(e,t="icon"){var i;const n=document.createElementNS(_o,"svg");n.setAttribute("class",t),n.setAttribute("viewBox","0 0 24 24"),n.setAttribute("fill","none"),n.setAttribute("aria-hidden","true"),n.setAttribute("focusable","false");const r="2",s=(i=tf[e])!==null&&i!==void 0?i:"",a=new DOMParser().parseFromString(`<svg xmlns="${_o}">${s}</svg>`,"image/svg+xml").documentElement;if(a.querySelector("parsererror"))return n;for(const o of Array.from(a.childNodes)){const c=document.importNode(o,!0);if(c.nodeType===Node.ELEMENT_NODE){const l=c;l.setAttribute("stroke","currentColor"),l.setAttribute("stroke-width",r),l.setAttribute("stroke-linecap","round"),l.setAttribute("stroke-linejoin","round"),l.setAttribute("fill",e==="icon-star"?"currentColor":"none")}n.appendChild(c)}return n}function Nt(e){const t=document.getElementById(e);if(!t)throw new Error(`缺少页面元素 #${e}，请强制刷新后重试`);return t}function xo(e,t,i,n,r){if(!e)return;const s=document.createElement("span");s.className="select-stat-nums";const a=document.createElement("strong");a.textContent=String(n);const o=document.createElement("span");o.className="select-stat-sep",o.textContent="/";const c=document.createElement("span");c.className="select-stat-cap",c.textContent=String(r),s.append(a,o,c);const l=document.createElement("span");l.className="select-stat-meta";const u=document.createElement("span");u.className="select-stat-label",u.textContent=i,l.append(u,s),e.replaceChildren(hn(t,"select-stat-icon"),l),e.setAttribute("aria-label",`${i} ${n} / ${r}`)}function nf(e,t){const i=document.createElement("span");i.className=t;for(let n=0;n<3;n++){const r=hn("icon-star",n<e?"cell-star lit":"cell-star");i.append(r)}return i}function On(e,t,i){e.replaceChildren(),e.append(hn(t)),e.classList.add("btn-icon"),e.setAttribute("aria-label",i),e.title=i}function br(e,t,i){const n=document.getElementById(e);n&&(n.replaceChildren(hn(t,"pad-icon")),n.setAttribute("aria-label",i))}function rf(){const e=[];let t="",i=1;for(let r=0;r<Kt;r++){var n;const s=(n=yr[r].chapter)!==null&&n!==void 0?n:"关卡";s!==t&&(t&&e.push({name:t,start:i,end:r}),t=s,i=r+1)}return t&&e.push({name:t,start:i,end:Kt}),e}var sf=class{constructor(){ae(this,"levelLabel",Nt("level-label")),ae(this,"movesLabel",Nt("moves-label")),ae(this,"muteBtn",Nt("btn-mute")),ae(this,"hintEl",document.getElementById("hint-mechanic")),ae(this,"fanfareEl",document.getElementById("clear-fanfare")),ae(this,"fanfareStars",document.getElementById("clear-stars")),ae(this,"fanfareCaption",document.getElementById("clear-caption")),ae(this,"swapBtn",document.getElementById("btn-swap")),On(Nt("btn-select"),"icon-grid","选关"),On(Nt("btn-undo"),"icon-undo","撤销"),On(Nt("btn-restart"),"icon-restart","重来"),this.swapBtn&&On(this.swapBtn,"icon-swap","切换"),br("pad-up","icon-arrow-up","上"),br("pad-left","icon-arrow-left","左"),br("pad-down","icon-arrow-down","下"),br("pad-right","icon-arrow-right","右")}setLevel(e){this.levelLabel.textContent=`第 ${e} / ${Kt} 关`}setMoves(e){this.movesLabel.textContent=`步数 ${e}`}setMuted(e){On(this.muteBtn,e?"icon-mute":"icon-sound","声音"),this.muteBtn.setAttribute("aria-pressed",e?"true":"false")}setHint(e){this.hintEl&&(e?(this.hintEl.textContent=e,this.hintEl.classList.remove("hidden")):(this.hintEl.textContent="",this.hintEl.classList.add("hidden")))}showClear(e,t){if(!(!this.fanfareEl||!this.fanfareStars||!this.fanfareCaption)){this.fanfareStars.replaceChildren();for(let i=0;i<3;i++){const n=hn("icon-star",i<e?"clear-star lit":"clear-star");this.fanfareStars.append(n)}this.fanfareCaption.textContent=`本关用了 ${t} 步，顺利到家！`,this.fanfareEl.classList.remove("hidden")}}hideClear(){var e,t;(e=this.fanfareEl)===null||e===void 0||e.classList.add("hidden"),(t=this.fanfareStars)===null||t===void 0||t.replaceChildren(),this.fanfareCaption&&(this.fanfareCaption.textContent="")}setSwapVisible(e){this.swapBtn&&this.swapBtn.classList.toggle("hidden",!e)}},af=class{constructor(){ae(this,"overlay",Nt("overlay")),ae(this,"panelSelect",Nt("panel-select")),ae(this,"panelWin",Nt("panel-win")),ae(this,"chaptersEl",Nt("level-chapters")),ae(this,"progressEl",document.getElementById("select-progress")),ae(this,"starsEl",document.getElementById("select-stars")),ae(this,"winText",Nt("win-text")),ae(this,"onPick",null),ae(this,"current",1),ae(this,"progress",{maxCleared:0,lastPlayed:1,muted:!1,stars:Array.from({length:Kt},()=>0)}),Nt("btn-close-select").addEventListener("click",()=>this.hide()),Nt("btn-win-select").addEventListener("click",()=>{this.hideWin(),this.show(this.current,this.progress)}),window.addEventListener("keydown",e=>{if(e.key==="Escape"&&!this.overlay.classList.contains("hidden")){if(e.preventDefault(),!this.panelWin.classList.contains("hidden")){this.hide();return}this.hide()}})}onSelect(e){this.onPick=e}show(e,t){this.current=e,this.progress=t,this.overlay.classList.remove("hidden"),this.overlay.inert=!1,this.overlay.setAttribute("aria-hidden","false"),this.panelSelect.classList.remove("hidden"),this.panelWin.classList.add("hidden"),this.render()}hide(){var e;this.releaseFocusFromOverlay(),this.overlay.classList.add("hidden"),this.overlay.inert=!0,this.overlay.setAttribute("aria-hidden","true"),this.panelSelect.classList.add("hidden"),this.panelWin.classList.add("hidden"),(e=document.getElementById("btn-select"))===null||e===void 0||e.focus({preventScroll:!0})}showWin(e,t){this.progress=t,this.overlay.classList.remove("hidden"),this.overlay.inert=!1,this.overlay.setAttribute("aria-hidden","false"),this.panelSelect.classList.add("hidden"),this.panelWin.classList.remove("hidden");const i=mo(t.stars);this.winText.textContent=`共走 ${e} 步，点亮 ${i} / ${po} 颗星。`}hideWin(){this.panelWin.classList.add("hidden")}releaseFocusFromOverlay(){const e=document.activeElement;e instanceof HTMLElement&&this.overlay.contains(e)&&e.blur()}render(){const e=this.progress.maxCleared;xo(this.progressEl,"icon-check","已通关",e,Kt),xo(this.starsEl,"icon-star","星星",mo(this.progress.stars),po),this.chaptersEl.replaceChildren();for(const t of rf()){const i=document.createElement("section");i.className="level-chapter";const n=document.createElement("header");n.className="chapter-head";const r=document.createElement("span");r.className="chapter-name",r.textContent=t.name;const s=document.createElement("span");s.className="chapter-range",s.textContent=`${t.start}–${t.end}`,n.append(r,s),i.appendChild(n);const a=document.createElement("div");a.className="level-grid";for(let o=t.start;o<=t.end;o++)a.appendChild(this.makeCell(o,e));i.appendChild(a),this.chaptersEl.appendChild(i)}}makeCell(e,t){const i=document.createElement("button");i.type="button",i.className="level-cell";const n=ef(e,t),r=document.createElement("span");if(r.className="level-num",r.textContent=String(e),n)i.classList.add("locked"),i.append(r,hn("icon-lock","icon icon-badge")),i.title="先完成前面的关卡",i.setAttribute("aria-label",`第 ${e} 关已锁定`);else if(e<=t){var s;const a=(s=this.progress.stars[e-1])!==null&&s!==void 0?s:1;i.classList.add("cleared"),i.append(r,nf(a,"cell-stars")),i.setAttribute("aria-label",`第 ${e} 关，已通关，${a} 星`)}else i.classList.add("next"),i.append(r),i.setAttribute("aria-label",`第 ${e} 关，可挑战`);return e===this.current&&i.classList.add("current"),i.addEventListener("click",()=>{var a;if(n){i.animate([{transform:"translateX(0)"},{transform:"translateX(-4px)"},{transform:"translateX(4px)"},{transform:"translateX(0)"}],{duration:200});return}this.hide(),(a=this.onPick)===null||a===void 0||a.call(this,e)}),i}},Mo="thebox:scene-prefs:v1",of=class{constructor(){var e;ae(this,"tweens",new ws),ae(this,"sceneSetup",void 0),ae(this,"level",void 0),ae(this,"player",void 0),ae(this,"input",new Wd),ae(this,"sfx",new Xd),ae(this,"hud",new sf),ae(this,"select",new af),ae(this,"progress",void 0),ae(this,"levelNo",1),ae(this,"moves",0),ae(this,"totalMoves",0),ae(this,"history",[]),ae(this,"world",fo(yr[0],0,0)),ae(this,"busy",!1),ae(this,"scenePrefs",{highAltitude:!1,cloudChallenge:!1}),ae(this,"loop",n=>{requestAnimationFrame(this.loop),this.tweens.update(n),this.sceneSetup.renderer.render(this.sceneSetup.scene,this.sceneSetup.camera)});const t=document.getElementById("game-canvas");this.sceneSetup=wd(t),this.level=new Gd(this.sceneSetup.scene,this.tweens),this.player=new Hd(this.sceneSetup.scene,this.level,this.tweens),this.progress=Jd(),this.sfx.setMuted(this.progress.muted),this.hud.setMuted(this.progress.muted),this.scenePrefs=this.loadScenePrefs(),this.bindScenePrefs(),this.applyScenePrefs(!1),this.input.onMove(n=>this.handleDir(n)),this.select.onSelect(n=>this.loadLevel(n)),document.getElementById("btn-select").addEventListener("click",()=>{this.select.show(this.levelNo,this.progress)}),document.getElementById("btn-undo").addEventListener("click",()=>this.undo()),document.getElementById("btn-restart").addEventListener("click",()=>this.restart()),document.getElementById("btn-mute").addEventListener("click",()=>this.toggleMute()),(e=document.getElementById("btn-swap"))===null||e===void 0||e.addEventListener("click",()=>this.swapEntity()),window.addEventListener("keydown",n=>{(n.key==="r"||n.key==="R")&&this.restart(),(n.key==="z"||n.key==="Z"||n.key==="Backspace")&&(n.preventDefault(),this.undo()),(n.key===" "||n.code==="Space")&&(n.preventDefault(),this.swapEntity())});const i=Math.min(Math.max(1,this.progress.lastPlayed),this.progress.maxCleared+1,Kt);this.loadLevel(i),requestAnimationFrame(this.loop)}loadScenePrefs(){try{var e;const t=JSON.parse((e=localStorage.getItem(Mo))!==null&&e!==void 0?e:"{}"),i=t.highAltitude===!0;return{highAltitude:i,cloudChallenge:i&&t.cloudChallenge===!0}}catch{return{highAltitude:!1,cloudChallenge:!1}}}bindScenePrefs(){const e=document.getElementById("toggle-high-altitude"),t=document.getElementById("toggle-cloud-challenge");e.addEventListener("change",()=>{this.scenePrefs.highAltitude=e.checked,e.checked||(this.scenePrefs.cloudChallenge=!1),this.applyScenePrefs(!0)}),t.addEventListener("change",()=>{this.scenePrefs.cloudChallenge=this.scenePrefs.highAltitude&&t.checked,this.applyScenePrefs(!0)})}applyScenePrefs(e){var t;const i=document.documentElement,n=document.getElementById("toggle-high-altitude"),r=document.getElementById("toggle-cloud-challenge");if(n.checked=this.scenePrefs.highAltitude,r.disabled=!this.scenePrefs.highAltitude,r.checked=this.scenePrefs.highAltitude&&this.scenePrefs.cloudChallenge,(t=r.closest(".scene-toggle"))===null||t===void 0||t.classList.toggle("is-disabled",r.disabled),i.classList.toggle("high-altitude",this.scenePrefs.highAltitude),i.classList.toggle("cloud-challenge",this.scenePrefs.cloudChallenge),this.level.setHighAltitude(this.scenePrefs.highAltitude),this.sceneSetup.setHighAltitude(this.scenePrefs.highAltitude),e)try{localStorage.setItem(Mo,JSON.stringify(this.scenePrefs))}catch{}}snapshot(){return{block:it(this.player.state),blockB:this.player.stateB?it(this.player.stateB):null,active:this.player.active,bridges:{...this.world.bridges},collapsed:{...this.world.collapsed},layer:this.world.layer}}applySnapshot(e){this.world={block:it(e.block),blockB:e.blockB?it(e.blockB):null,active:e.active,bridges:{...e.bridges},collapsed:{...e.collapsed},layer:e.layer},e.blockB?this.player.placeSplit(e.block,e.blockB,e.active):this.player.placeMerged(e.block),this.level.syncBridges(e.bridges),this.level.syncCollapsed(e.collapsed)}loadLevel(e){var t;this.busy=!1,this.levelNo=e,this.moves=0,this.history=[],this.progress.lastPlayed=e,bs(this.progress);const i=Es(e-1),n=ho(i),r=uo();this.level.load(i,0,n,r),this.level.parsed&&this.sceneSetup.frameBoard(this.level.parsed.cols,this.level.parsed.rows),this.world=fo(i,this.level.startCol,this.level.startRow),this.world.bridges=n,this.world.collapsed=r,this.player.reset(this.world.block),this.hud.setLevel(e),this.hud.setMoves(0);const s=(t=i.hint)!==null&&t!==void 0?t:e===1?"把小方块送回家。":"";this.hud.setHint(s),this.hud.hideClear(),this.hud.setSwapVisible(!1),this.input.setEnabled(!0)}handleDir(e){if(this.sfx.unlock(),this.busy||!this.player.canMove)return;const t=this.snapshot();this.player.tryMove(e,()=>this.afterMove(t,e),()=>this.sfx.land())&&this.sfx.move()}punchCamera(){const e=this.sceneSetup.cameraPivot,t=e.position.y,i={y:t};new Mt(i,this.tweens).to({y:t+.18},wt(140)).easing(dt.Quadratic.Out).yoyo(!0).repeat(1).onUpdate(()=>{e.position.y=i.y}).onComplete(()=>{e.position.y=t}).start()}swapEntity(){this.busy||!this.player.isSplit||(this.player.toggleActive(),this.world.active=this.player.active,this.sfx.beep(240,40,.12))}afterMove(e,t){this.history.push(e),this.history.length>50&&this.history.shift(),this.moves++,this.totalMoves++,this.hud.setMoves(this.moves);const i=Es(this.levelNo-1),n=this.level.parsed;let r={...this.world.bridges},s={...this.world.collapsed};const a=e.blockB?e.active===0?e.block:e.blockB:e.block,o=Vt(a),c=this.player.isSplit?this.player.active===0?this.player.state:this.player.stateB:this.player.state;r=Fd(n,c,r,this.player.isSplit),this.world.bridges=r,this.level.syncBridges(r);const l=Bd(n,this.player.state,this.player.isSplit);if(l){const h=Vt(l);s=ys(n,o,h,s),this.world.collapsed=s,this.level.syncCollapsed(s),this.busy=!0,this.input.setEnabled(!1),this.sfx.beep(560,70,.16,"sine"),this.player.animateTeleport(l,()=>{if(this.world.block=it(this.player.state),this.world.blockB=null,this.world.active=0,this.busy=!1,this.input.setEnabled(!0),this.level.isDeath(this.player.state,r,s)){this.onDeath(t);return}this.level.isWin(this.player.state,r,s)&&this.onWin()}),this.world.block=it(l);return}if(!this.player.isSplit&&n.splitPads.length){const h=Vt(this.player.state);for(const d of n.splitPads)if(h.some(_=>_.col===d.col&&_.row===d.row)){const _={col:d.destA[0],row:d.destA[1],ori:"standing"},M={col:d.destB[0],row:d.destB[1],ori:"standing"},m=[...Vt(_),...Vt(M)];s=ys(n,o,m,s),this.world.collapsed=s,this.level.syncCollapsed(s),this.busy=!0,this.input.setEnabled(!1),this.sfx.beep(320,80,.2),this.player.animateSplit(_,M,()=>{this.world.block=it(this.player.state),this.world.blockB=this.player.stateB?it(this.player.stateB):null,this.world.active=this.player.active,this.hud.setSwapVisible(!0),this.busy=!1,this.input.setEnabled(!0),(this.cubeDead(this.player.state)||this.player.stateB&&this.cubeDead(this.player.stateB))&&this.onDeath(t)}),this.world.block=it(_),this.world.blockB=it(M),this.world.active=0;return}}if(this.player.isSplit&&this.player.stateB&&Pd(this.player.state,this.player.stateB)){const h=Id(this.player.state,this.player.stateB);this.player.placeMerged(h),this.world.block=it(h),this.world.blockB=null,this.hud.setSwapVisible(!1),this.sfx.beep(400,60,.18)}if(i.layers&&i.layers.length>1&&!this.player.isSplit&&Vt(this.player.state).some(h=>Ss(n,h.col,h.row)==="u")&&this.player.state.ori==="standing"){const h=(this.world.layer+1)%i.layers.length;h!==this.world.layer&&(this.world.layer=h,this.level.setLayer(h,this.world.bridges,s),this.player.placeMerged(this.player.state),this.sfx.beep(280,70,.15))}const u=this.player.stateB?[...Vt(this.player.state),...Vt(this.player.stateB)]:Vt(this.player.state),f=this.world.collapsed;if(s=ys(n,o,u,f),s!==f&&(this.world.collapsed=s,this.level.syncCollapsed(s),this.sfx.beep(150,50,.12,"triangle")),this.world.block=it(this.player.state),this.world.blockB=this.player.stateB?it(this.player.stateB):null,this.world.active=this.player.active,this.player.isSplit){const h=this.cubeDead(this.player.state),d=this.cubeDead(this.player.stateB);if(h||d){this.onDeath(t);return}return}if(this.level.isDeath(this.player.state,r,s)){this.onDeath(t);return}this.level.isWin(this.player.state,r,s)&&this.onWin()}causeFor(e,t){return co(this.level.parsed,e,this.world.bridges,this.world.collapsed,t)}cubeDead(e){return this.causeFor(e,!0)!==null}deathOutcome(){return this.player.stateB?{a:this.causeFor(this.player.state,!0),b:this.causeFor(this.player.stateB,!0)}:{a:this.causeFor(this.player.state,!1),b:null}}onDeath(e){this.busy=!0,this.input.setEnabled(!1),this.player.setMood("surprised");const t=this.deathOutcome(),i=[],n=[];for(const s of["a","b"])t[s]==="fall"&&i.push(s),t[s]==="hazard"&&n.push(s);const r=()=>{this.history=[],this.moves=0,this.hud.setMoves(0),this.loadLevel(this.levelNo),this.busy=!1};if(this.scenePrefs.highAltitude&&i.length>0){Ms()?this.sfx.fail():this.sfx.fallWind(900),this.player.fallHighAltitude(i,n,e,r);return}this.sfx.fail(),this.level.shake(),this.player.fall(r)}onWin(){this.busy=!0,this.input.setEnabled(!1),this.sfx.win(),this.punchCamera();const e=this.moves,t=Kd(e,this.levelNo);this.progress=Qd(this.progress,this.levelNo,t),this.levelNo>this.progress.maxCleared&&(this.progress.maxCleared=this.levelNo),bs(this.progress),this.hud.showClear(t,e),this.player.win(()=>{if(this.levelNo>=Kt){this.hud.hideClear(),this.select.showWin(this.totalMoves,this.progress),this.busy=!1;return}this.sfx.clearLevel(),window.setTimeout(()=>{this.hud.hideClear(),this.level.remove(()=>{this.loadLevel(this.levelNo+1),this.busy=!1})},800)})}undo(){if(this.busy||!this.player.canMove)return;const e=this.history.pop();e&&(this.moves=Math.max(0,this.moves-1),this.hud.setMoves(this.moves),Es(this.levelNo-1).layers&&e.layer!==this.world.layer&&this.level.setLayer(e.layer,e.bridges,e.collapsed),this.applySnapshot(e),this.hud.setSwapVisible(!!e.blockB),this.sfx.beep(160,40,.15))}restart(){this.busy||this.loadLevel(this.levelNo)}toggleMute(){this.progress.muted=!this.progress.muted,this.sfx.setMuted(this.progress.muted),this.hud.setMuted(this.progress.muted),bs(this.progress)}};try{new of}catch(e){const t=e instanceof Error?e.message:String(e);console.error("[翻砖块]",t,e);const i=document.createElement("div");i.setAttribute("role","alert"),i.style.cssText="position:fixed;inset:12px;z-index:99;padding:16px;border-radius:12px;background:#fff;color:#c0392b;font:600 14px/1.5 sans-serif;box-shadow:0 8px 24px rgba(0,0,0,.2);white-space:pre-wrap",i.textContent=t.includes("WebGL")?"暂时无法显示立体画面。请换用较新的浏览器，或在浏览器设置中打开硬件加速后重试。":"游戏暂时无法启动。请刷新页面后再试。",document.body.appendChild(i)}})();
